...
#ifndef COMPONENTWEBOTSROBOTARM_EXTENSION_HH_
#define COMPONENTWEBOTSROBOTARM_EXTENSION_HH_
...
public:
	ComponentWebotsRobotArmExtension(const std::string &name);
	virtual ~ComponentWebotsRobotArmExtension();
...
#endif /* COMPONENTWEBOTSROBOTARM_EXTENSION_HH_ */
