...
#ifndef COMPONENTROBOTINOIMAGESERVER_EXTENSION_HH_
#define COMPONENTROBOTINOIMAGESERVER_EXTENSION_HH_
...
public:
	ComponentRobotinoImageServerExtension(const std::string &name);
	virtual ~ComponentRobotinoImageServerExtension();
...
#endif /* COMPONENTROBOTINOIMAGESERVER_EXTENSION_HH_ */
