...
int main(int argc, char *argv[])
{
	...
	ComponentRobotinoImageServer::instance()->init(argc, argv);
	// run component infrastructure until the component is commanded to shutdown
	ComponentRobotinoImageServer::instance()->run();
	// clean-up component's internal resources (deleting ports, tasks, etc.)
	ComponentRobotinoImageServer::instance()->fini();
	// destroy the component's singleton
	ComponentRobotinoImageServer::deleteInstance();
