...
RGBImageQueryServiceAnswHandler::RGBImageQueryServiceAnswHandler(IQueryServer *server)
:	RGBImageQueryServiceAnswHandlerCore(server)
{
	
}


void RGBImageQueryServiceAnswHandler::handleQuery(const Smart::QueryIdPtr &id, const CommBasicObjects::CommVoid& request) 
{
