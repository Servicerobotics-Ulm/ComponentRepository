...
#ifndef COMPONENTUNICAPIMAGECLIENT_EXTENSION_HH_
#define COMPONENTUNICAPIMAGECLIENT_EXTENSION_HH_
...
public:
	ComponentUnicapImageClientExtension(const std::string &name);
	virtual ~ComponentUnicapImageClientExtension();
...
#endif /* COMPONENTUNICAPIMAGECLIENT_EXTENSION_HH_ */
