# target configurations for ComponentUnicapImageClientROS1InterfacesExtension

# target configurations for ComponentUnicapImageClientROSExtension
IF(EXISTS ${ROS_DIR})
TARGET_LINK_LIBRARIES(${PROJECT_NAME} ${ROS_LIBS})
ENDIF(EXISTS ${ROS_DIR})

# target configurations for ComponentUnicapImageClientRestInterfacesExtension
...
# target configurations for PlainOpcUaComponentUnicapImageClientExtension
