...
//--------------------------------------------------------------------------
#ifndef _PUSHNEWESTCLIENT_INPUT_COLLECTOR_HH
#define _PUSHNEWESTCLIENT_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** PushNewestClientInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort pushNewestClient and at the same time acts itself
 ...
 */
class PushNewestClientInputCollector
:	public Smart::IInputHandler<DomainVision::CommVideoImage>
,	public Smart::InputSubject<DomainVision::CommVideoImage>
{
public:
	PushNewestClientInputCollector(Smart::InputSubject<DomainVision::CommVideoImage> *subject)
	:	Smart::IInputHandler<DomainVision::CommVideoImage>(subject)
	{  }
	virtual ~PushNewestClientInputCollector() = default;
...
#endif // _PUSHNEWESTCLIENT_INPUT_COLLECTOR_HH
