...
//--------------------------------------------------------------------------
#ifndef _GUITASK_CORE_HH
#define _GUITASK_CORE_HH
...
#include <GuiTaskObserverInterface.hh>
...
private:
	...
	std::list<GuiTaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(GuiTaskObserverInterface *observer);
	void detach_interaction_observer(GuiTaskObserverInterface *observer);

public:
	GuiTaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~GuiTaskCore();
