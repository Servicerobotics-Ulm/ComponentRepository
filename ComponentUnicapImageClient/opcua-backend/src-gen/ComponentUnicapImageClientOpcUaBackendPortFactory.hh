...
#ifndef COMPONENTUNICAPIMAGECLIENT_OPC_UA_BACKEND_PORTFACTORY_HH_
#define COMPONENTUNICAPIMAGECLIENT_OPC_UA_BACKEND_PORTFACTORY_HH_
...
class ComponentUnicapImageClientOpcUaBackendPortFactory: public ComponentUnicapImageClientPortFactoryInterface
{
private:
	...
	int task_execution();
public:
	ComponentUnicapImageClientOpcUaBackendPortFactory();
	virtual ~ComponentUnicapImageClientOpcUaBackendPortFactory();
...
#endif /* COMPONENTUNICAPIMAGECLIENT_SERONET_SDK_PORTFACTORY_HH_ */
