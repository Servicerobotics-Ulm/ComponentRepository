...
//--------------------------------------------------------------------------
#ifndef _JOBSOURCE3EVENTCLIENT_INPUT_COLLECTOR_HH
#define _JOBSOURCE3EVENTCLIENT_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** JobSource3EventClientInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort jobSource3EventClient and at the same time acts itself
 ...
 */
class JobSource3EventClientInputCollector
...
{
public:
	JobSource3EventClientInputCollector(Smart::InputSubject<Smart::EventInputType<CommBasicObjects::CommTaskMessage>> *subject)
	:	Smart::IInputHandler<Smart::EventInputType<CommBasicObjects::CommTaskMessage>>(subject)
	{  }
	virtual ~JobSource3EventClientInputCollector() = default;
...
#endif // _JOBSOURCE3EVENTCLIENT_INPUT_COLLECTOR_HH
