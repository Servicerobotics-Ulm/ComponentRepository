...
//--------------------------------------------------------------------------
#ifndef _DUMMY_CORE_HH
#define _DUMMY_CORE_HH
...
#include <DummyObserverInterface.hh>
...
protected:
	...
	Smart::StatusCode taskResultOutPut(CommBasicObjects::CommTaskMessage &taskResultOutDataObject);
	// this method is meant to be used in derived classes
	Smart::StatusCode jobEventServerPut(CommBasicObjects::CommTaskEventState &eventState);
...
private:
	...
	std::list<DummyObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(DummyObserverInterface *observer);
	void detach_interaction_observer(DummyObserverInterface *observer);

public:
	DummyCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~DummyCore();
