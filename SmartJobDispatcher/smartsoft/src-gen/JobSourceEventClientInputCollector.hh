...
//--------------------------------------------------------------------------
#ifndef _JOBSOURCEEVENTCLIENT_INPUT_COLLECTOR_HH
#define _JOBSOURCEEVENTCLIENT_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** JobSourceEventClientInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort jobSourceEventClient and at the same time acts itself
 ...
 */
class JobSourceEventClientInputCollector
...
{
public:
	JobSourceEventClientInputCollector(Smart::InputSubject<Smart::EventInputType<CommBasicObjects::CommTaskMessage>> *subject)
	:	Smart::IInputHandler<Smart::EventInputType<CommBasicObjects::CommTaskMessage>>(subject)
	{  }
	virtual ~JobSourceEventClientInputCollector() = default;
...
#endif // _JOBSOURCEEVENTCLIENT_INPUT_COLLECTOR_HH
