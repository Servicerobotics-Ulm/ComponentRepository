...
#ifndef SMARTJOBDISPATCHER_EXTENSION_HH_
#define SMARTJOBDISPATCHER_EXTENSION_HH_
...
public:
	SmartJobDispatcherExtension(const std::string &name);
	virtual ~SmartJobDispatcherExtension();
...
#endif /* SMARTJOBDISPATCHER_EXTENSION_HH_ */
