...
//--------------------------------------------------------------------------
#ifndef _SEQUENCERSENDSERVER_INPUT_COLLECTOR_HH
#define _SEQUENCERSENDSERVER_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** SequencerSendServerInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort sequencerSendServer and at the same time acts itself
 ...
 */
class SequencerSendServerInputCollector
:	public Smart::IInputHandler<CommBasicObjects::CommSkillMsg>
,	public Smart::InputSubject<CommBasicObjects::CommSkillMsg>
{
public:
	SequencerSendServerInputCollector(Smart::InputSubject<CommBasicObjects::CommSkillMsg> *subject)
	:	Smart::IInputHandler<CommBasicObjects::CommSkillMsg>(subject)
	{  }
	virtual ~SequencerSendServerInputCollector() = default;
...
#endif // _SEQUENCERSENDSERVER_INPUT_COLLECTOR_HH
