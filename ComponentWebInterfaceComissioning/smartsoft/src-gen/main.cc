...
int main(int argc, char *argv[])
{
	...
	ComponentWebInterfaceComissioning::instance()->init(argc, argv);
	// run component infrastructure until the component is commanded to shutdown
	ComponentWebInterfaceComissioning::instance()->run();
	// clean-up component's internal resources (deleting ports, tasks, etc.)
	ComponentWebInterfaceComissioning::instance()->fini();
	// destroy the component's singleton
	ComponentWebInterfaceComissioning::deleteInstance();
