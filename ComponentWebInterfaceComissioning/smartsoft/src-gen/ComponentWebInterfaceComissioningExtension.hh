...
#ifndef COMPONENTWEBINTERFACECOMISSIONING_EXTENSION_HH_
#define COMPONENTWEBINTERFACECOMISSIONING_EXTENSION_HH_
...
public:
	ComponentWebInterfaceComissioningExtension(const std::string &name);
	virtual ~ComponentWebInterfaceComissioningExtension();
...
#endif /* COMPONENTWEBINTERFACECOMISSIONING_EXTENSION_HH_ */
