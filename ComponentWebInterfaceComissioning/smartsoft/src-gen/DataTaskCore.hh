...
//--------------------------------------------------------------------------
#ifndef _DATATASK_CORE_HH
#define _DATATASK_CORE_HH
...
#include <DataTaskObserverInterface.hh>
...
private:
	...
	std::list<DataTaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(DataTaskObserverInterface *observer);
	void detach_interaction_observer(DataTaskObserverInterface *observer);

public:
	DataTaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~DataTaskCore();
