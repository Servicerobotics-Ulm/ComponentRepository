...
//--------------------------------------------------------------------------
#ifndef _WORKERTASK_CORE_HH
#define _WORKERTASK_CORE_HH
...
#include <WorkerTaskObserverInterface.hh>


class WorkerTaskCore
...
protected:
	...
	Smart::StatusCode sequencerEventServerPut(CommBasicObjects::CommSkillMsg &eventState);
...
private:
	...
	std::list<WorkerTaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(WorkerTaskObserverInterface *observer);
	void detach_interaction_observer(WorkerTaskObserverInterface *observer);

public:
	WorkerTaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~WorkerTaskCore();
