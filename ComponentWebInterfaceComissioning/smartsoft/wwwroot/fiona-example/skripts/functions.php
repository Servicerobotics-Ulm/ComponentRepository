...
function printMenu(){
		...
		$m_lbs = $script == "lbs.php" ? 'class="ui-btn-active ui-state-persist"' : "";
...
//                	echo '<li><a target="_parent" href="'.$basepath.'navigation.php" data-icon="cus-walk" data-theme="c" '.$m_navigation.' data-transition="fade">HSU Navigation</a></li>';
                	echo '<li><a target="_parent" href="'.$basepath.'lbs.php" data-icon="cus-command" data-theme="c" '.$m_lbs.' data-transition="fade">Place Order</a></li>';
