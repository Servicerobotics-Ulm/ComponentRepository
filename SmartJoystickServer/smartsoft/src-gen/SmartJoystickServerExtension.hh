...
#ifndef SMARTJOYSTICKSERVER_EXTENSION_HH_
#define SMARTJOYSTICKSERVER_EXTENSION_HH_
...
public:
	SmartJoystickServerExtension(const std::string &name);
	virtual ~SmartJoystickServerExtension();
...
#endif /* SMARTJOYSTICKSERVER_EXTENSION_HH_ */
