...
# target configurations for PlainOpcUaSmartJoystickServerExtension
...
# target configurations for SmartJoystickServerROS1InterfacesExtension

# target configurations for SmartJoystickServerROSExtension
IF(EXISTS ${ROS_DIR})
TARGET_LINK_LIBRARIES(${PROJECT_NAME} ${ROS_LIBS})
ENDIF(EXISTS ${ROS_DIR})

# target configurations for SmartJoystickServerRestInterfacesExtension
