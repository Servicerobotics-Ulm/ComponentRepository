...
#ifndef COMPONENTKINECTV1SERVER_EXTENSION_HH_
#define COMPONENTKINECTV1SERVER_EXTENSION_HH_
...
public:
	ComponentKinectV1ServerExtension(const std::string &name);
	virtual ~ComponentKinectV1ServerExtension();
...
#endif /* COMPONENTKINECTV1SERVER_EXTENSION_HH_ */
