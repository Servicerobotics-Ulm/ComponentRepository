...
//--------------------------------------------------------------------------
#ifndef _READLASERTASK_CORE_HH
#define _READLASERTASK_CORE_HH
...
#include <ReadLaserTaskObserverInterface.hh>


class ReadLaserTaskCore
...
private:
	...
	std::list<ReadLaserTaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(ReadLaserTaskObserverInterface *observer);
	void detach_interaction_observer(ReadLaserTaskObserverInterface *observer);

public:
	ReadLaserTaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~ReadLaserTaskCore();
