...
#ifndef COMPONENTROBOTINOLASERSERVER_EXTENSION_HH_
#define COMPONENTROBOTINOLASERSERVER_EXTENSION_HH_
...
public:
	ComponentRobotinoLaserServerExtension(const std::string &name);
	virtual ~ComponentRobotinoLaserServerExtension();
...
#endif /* COMPONENTROBOTINOLASERSERVER_EXTENSION_HH_ */
