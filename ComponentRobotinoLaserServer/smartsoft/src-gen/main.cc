...
int main(int argc, char *argv[])
{
	...
	ComponentRobotinoLaserServer::instance()->init(argc, argv);
	// run component infrastructure until the component is commanded to shutdown
	ComponentRobotinoLaserServer::instance()->run();
	// clean-up component's internal resources (deleting ports, tasks, etc.)
	ComponentRobotinoLaserServer::instance()->fini();
	// destroy the component's singleton
	ComponentRobotinoLaserServer::deleteInstance();
