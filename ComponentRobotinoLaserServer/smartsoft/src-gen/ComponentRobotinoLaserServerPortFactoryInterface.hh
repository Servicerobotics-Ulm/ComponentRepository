...
public:
	...
	virtual Smart::IQueryServerPattern<CommBasicObjects::CommVoid, CommBasicObjects::CommMobileLaserScan,SmartACE::QueryId> * createQueryServer(const std::string &serviceName) = 0;
