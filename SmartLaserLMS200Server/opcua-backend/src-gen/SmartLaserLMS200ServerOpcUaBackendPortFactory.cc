...
#include "SmartLaserLMS200ServerOpcUaBackendPortFactory.hh"
...
SmartLaserLMS200ServerOpcUaBackendPortFactory::SmartLaserLMS200ServerOpcUaBackendPortFactory()
{  
	componentImpl = 0;
	SmartLaserLMS200Server::instance()->addPortFactory("OpcUa_SeRoNet", this);
}

SmartLaserLMS200ServerOpcUaBackendPortFactory::~SmartLaserLMS200ServerOpcUaBackendPortFactory()
{  }

void SmartLaserLMS200ServerOpcUaBackendPortFactory::initialize(SmartLaserLMS200Server *component, int argc, char* argv[])
{
	componentImpl = new SeRoNet::Utils::Component(component->connections.component.name);
}

int SmartLaserLMS200ServerOpcUaBackendPortFactory::onStartup()
{
	if (!component_thread.joinable()) {
    	component_thread = std::thread(&SmartLaserLMS200ServerOpcUaBackendPortFactory::task_execution, this);
    	return 0;
    }
	return -1;
}

Smart::IPushClientPattern<CommBasicObjects::CommBaseState> * SmartLaserLMS200ServerOpcUaBackendPortFactory::createBaseStateIn()
{
...
int SmartLaserLMS200ServerOpcUaBackendPortFactory::task_execution()
{
	componentImpl->run();
	return 0;
}

int SmartLaserLMS200ServerOpcUaBackendPortFactory::onShutdown(const std::chrono::steady_clock::duration &timeoutTime)
{
...
void SmartLaserLMS200ServerOpcUaBackendPortFactory::destroy()
{
