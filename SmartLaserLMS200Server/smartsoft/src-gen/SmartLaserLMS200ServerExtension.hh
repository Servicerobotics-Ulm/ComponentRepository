...
#ifndef SMARTLASERLMS200SERVER_EXTENSION_HH_
#define SMARTLASERLMS200SERVER_EXTENSION_HH_
...
public:
	SmartLaserLMS200ServerExtension(const std::string &name);
	virtual ~SmartLaserLMS200ServerExtension();
...
#endif /* SMARTLASERLMS200SERVER_EXTENSION_HH_ */
