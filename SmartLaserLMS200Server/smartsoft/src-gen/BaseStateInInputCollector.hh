...
//--------------------------------------------------------------------------
#ifndef _BASESTATEIN_INPUT_COLLECTOR_HH
#define _BASESTATEIN_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** BaseStateInInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort BaseStateIn and at the same time acts itself
...
#endif // _BASESTATEIN_INPUT_COLLECTOR_HH
