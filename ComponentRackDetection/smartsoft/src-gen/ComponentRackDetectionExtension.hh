...
#ifndef COMPONENTRACKDETECTION_EXTENSION_HH_
#define COMPONENTRACKDETECTION_EXTENSION_HH_
...
public:
	ComponentRackDetectionExtension(const std::string &name);
	virtual ~ComponentRackDetectionExtension();
...
#endif /* COMPONENTRACKDETECTION_EXTENSION_HH_ */
