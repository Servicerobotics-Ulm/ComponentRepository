...
#ifndef COMPONENTRACKDETECTION_PORTFACTORYINTERFACE_HH_
#define COMPONENTRACKDETECTION_PORTFACTORYINTERFACE_HH_
...
// forward declaration
class ComponentRackDetection;

class ComponentRackDetectionPortFactoryInterface {
public:
	ComponentRackDetectionPortFactoryInterface() { };
	virtual ~ComponentRackDetectionPortFactoryInterface() { };

	virtual void initialize(ComponentRackDetection *component, int argc, char* argv[]) = 0;
	virtual int onStartup() = 0;

	virtual Smart::IQueryClientPattern<CommBasicObjects::CommVoid, DomainVision::CommRGBDImage> * createKinectQueryClient() = 0;
...
#endif /* COMPONENTRACKDETECTION_PORTFACTORYINTERFACE_HH_ */
