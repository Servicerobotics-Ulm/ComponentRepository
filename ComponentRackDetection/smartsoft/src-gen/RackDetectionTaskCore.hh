...
//--------------------------------------------------------------------------
#ifndef _RACKDETECTIONTASK_CORE_HH
#define _RACKDETECTIONTASK_CORE_HH
...
#include <RackDetectionTaskObserverInterface.hh>


class RackDetectionTaskCore
...
private:
	...
	std::list<RackDetectionTaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(RackDetectionTaskObserverInterface *observer);
	void detach_interaction_observer(RackDetectionTaskObserverInterface *observer);

public:
	RackDetectionTaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~RackDetectionTaskCore();
