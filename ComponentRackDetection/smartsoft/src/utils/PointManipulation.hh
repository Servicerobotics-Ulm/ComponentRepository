...
public:
	...
	PointManipulation();
	PointManipulation(CommBasicObjects::CommPose3d sensor_pose,	std::vector<double> depth_intrinsic, std::vector<double> color_intrinsic, DomainVision::CommDepthImage* depth_image);
	...
	pcl::PointCloud<pcl::PointXYZ>::Ptr removeObjectFromPC(pcl::PointCloud<pcl::PointXYZ>::Ptr point_cloud, std::vector<float> obj_center_xyz, std::vector<float> obj_dimensions_xyz, mrpt::poses::CPose3D obj_center_pose);
