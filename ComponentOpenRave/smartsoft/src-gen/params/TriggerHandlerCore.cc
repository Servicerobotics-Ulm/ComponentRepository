...
int TriggerHandlerCore::on_execute()
{
	...
	
	{
		...
		case TriggerEnumerators::COMMMANIPULATIONPLANNEROBJECTS_MANIPULATIONPLANNERPARAMETER_PLAN_FURNITURE_MANIPUATION_TASK:
			current_CommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_FURNITURE_MANIPUATION_TASK = CommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_FURNITURE_MANIPUATION_TASK_queue.front();
			CommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_FURNITURE_MANIPUATION_TASK_queue.pop();
			break;
		case TriggerEnumerators::COMMMANIPULATIONPLANNEROBJECTS_MANIPULATIONPLANNERPARAMETER_PLAN_PATH_TARGET_JOINT_ANGLES:
			current_CommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_PATH_TARGET_JOINT_ANGLES = CommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_PATH_TARGET_JOINT_ANGLES_queue.front();
			CommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_PATH_TARGET_JOINT_ANGLES_queue.pop();
			break;
		case TriggerEnumerators::COMMMANIPULATIONPLANNEROBJECTS_MANIPULATIONPLANNERPARAMETER_PLAN_PATH_TARGET_TCP_POSE:
			current_CommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_PATH_TARGET_TCP_POSE = CommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_PATH_TARGET_TCP_POSE_queue.front();
			CommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_PATH_TARGET_TCP_POSE_queue.pop();
			break;
		}
	} // mutex release
	...
	switch(current_trigger_enumerator) {
	case TriggerEnumerators::COMMMANIPULATIONPLANNEROBJECTS_MANIPULATIONPLANNERPARAMETER_PLAN_FURNITURE_MANIPUATION_TASK:
		this->handleCommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_FURNITURE_MANIPUATION_TASK(current_CommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_FURNITURE_MANIPUATION_TASK.mode, current_CommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_FURNITURE_MANIPUATION_TASK.furnitureIdentifier, current_CommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_FURNITURE_MANIPUATION_TASK.doorIdentifier, current_CommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_FURNITURE_MANIPUATION_TASK.openAmount);
		break;
	case TriggerEnumerators::COMMMANIPULATIONPLANNEROBJECTS_MANIPULATIONPLANNERPARAMETER_PLAN_PATH_TARGET_JOINT_ANGLES:
		this->handleCommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_PATH_TARGET_JOINT_ANGLES(current_CommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_PATH_TARGET_JOINT_ANGLES.angles);
		break;
	case TriggerEnumerators::COMMMANIPULATIONPLANNEROBJECTS_MANIPULATIONPLANNERPARAMETER_PLAN_PATH_TARGET_TCP_POSE:
		this->handleCommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_PATH_TARGET_TCP_POSE(current_CommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_PATH_TARGET_TCP_POSE.x, current_CommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_PATH_TARGET_TCP_POSE.y, current_CommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_PATH_TARGET_TCP_POSE.z, current_CommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_PATH_TARGET_TCP_POSE.azimuth, current_CommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_PATH_TARGET_TCP_POSE.elevation, current_CommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_PATH_TARGET_TCP_POSE.roll);
		break;
	}
	return 0;
}
...
//
	...
	void TriggerHandlerCore::handleCommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_FURNITURE_MANIPUATION_TASKCore(const PLAN_FURNITURE_MANIPUATION_TASKType::modeType &mode, const unsigned int &furnitureIdentifier, const unsigned int &doorIdentifier, const double &openAmount)
	{
		...
		CommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_FURNITURE_MANIPUATION_TASKAttributes attr;
		attr.doorIdentifier = doorIdentifier;
		attr.furnitureIdentifier = furnitureIdentifier;
		attr.mode = mode;
		attr.openAmount = openAmount;
		CommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_FURNITURE_MANIPUATION_TASK_queue.push(attr);
		
		// store the current trigger call in the shared trigger-queue
		trigger_queue.push(TriggerEnumerators::COMMMANIPULATIONPLANNEROBJECTS_MANIPULATIONPLANNERPARAMETER_PLAN_FURNITURE_MANIPUATION_TASK);
	...
	void TriggerHandlerCore::handleCommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_PATH_TARGET_JOINT_ANGLESCore(const std::list<double> &angles)
	{
		...
		// store the current set of trigger-attributes in a queue
		CommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_PATH_TARGET_JOINT_ANGLESAttributes attr;
		attr.angles = angles;
		CommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_PATH_TARGET_JOINT_ANGLES_queue.push(attr);
		
		// store the current trigger call in the shared trigger-queue
		trigger_queue.push(TriggerEnumerators::COMMMANIPULATIONPLANNEROBJECTS_MANIPULATIONPLANNERPARAMETER_PLAN_PATH_TARGET_JOINT_ANGLES);
	...
	void TriggerHandlerCore::handleCommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_PATH_TARGET_TCP_POSECore(const double &x, const double &y, const double &z, const double &azimuth, const double &elevation, const double &roll)
	{
		...
		// store the current set of trigger-attributes in a queue
		CommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_PATH_TARGET_TCP_POSEAttributes attr;
		...
		attr.y = y;
		attr.z = z;
		CommManipulationPlannerObjects_ManipulationPlannerParameter_PLAN_PATH_TARGET_TCP_POSE_queue.push(attr);
		
		// store the current trigger call in the shared trigger-queue
		trigger_queue.push(TriggerEnumerators::COMMMANIPULATIONPLANNEROBJECTS_MANIPULATIONPLANNERPARAMETER_PLAN_PATH_TARGET_TCP_POSE);
