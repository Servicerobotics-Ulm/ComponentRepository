...
//--------------------------------------------------------------------------
#ifndef _TRAJECTORYSAMPLING_CORE_HH
#define _TRAJECTORYSAMPLING_CORE_HH
...
private:
	...
	std::list<TrajectorySamplingObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(TrajectorySamplingObserverInterface *observer);
	void detach_interaction_observer(TrajectorySamplingObserverInterface *observer);

public:
	TrajectorySamplingCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~TrajectorySamplingCore();
