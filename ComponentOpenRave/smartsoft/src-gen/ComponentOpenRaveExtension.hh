...
#ifndef COMPONENTOPENRAVE_EXTENSION_HH_
#define COMPONENTOPENRAVE_EXTENSION_HH_
...
public:
	ComponentOpenRaveExtension(const std::string &name);
	virtual ~ComponentOpenRaveExtension();
...
#endif /* COMPONENTOPENRAVE_EXTENSION_HH_ */
