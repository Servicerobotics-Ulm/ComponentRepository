...
#ifndef _UNIVERSALROBOT6855A_HH
#define _UNIVERSALROBOT6855A_HH
...
/**
 * Manipulator specific class which includes all UniversalRobot specific code.
 */
class UniversalRobot6855A: public Manipulator {
