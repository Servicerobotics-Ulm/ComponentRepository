...
#ifndef COMPONENTTCLSEQUENCER_EXTENSION_HH_
#define COMPONENTTCLSEQUENCER_EXTENSION_HH_
...
public:
	ComponentTCLSequencerExtension(const std::string &name);
	virtual ~ComponentTCLSequencerExtension();
...
#endif /* COMPONENTTCLSEQUENCER_EXTENSION_HH_ */
