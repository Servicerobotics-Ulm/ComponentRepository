...
protected:
	...
	Smart::StatusCode basePositionUpdateClientPut(CommBasicObjects::CommBasePositionUpdate &basePositionUpdateClientDataObject);
	// this method is meant to be used in derived classes
	Smart::StatusCode newestMapPushServerPut(CommNavigationObjects::CommGridMap &newestMapPushServerDataObject);
