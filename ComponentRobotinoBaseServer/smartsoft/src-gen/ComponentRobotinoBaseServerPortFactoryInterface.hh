...
public:
	...
	virtual Smart::IEventClientPattern<CommLocalizationObjects::CommLocalizationEventParameter, CommLocalizationObjects::CommLocalizationEventResult,SmartACE::EventId> * createLocalizationEventServiceIn() = 0;
	
	virtual Smart::IQueryServerPattern<CommBasicObjects::CommVoid, CommBasicObjects::CommBaseState,SmartACE::QueryId> * createBaseStateQueryServiceAnsw(const std::string &serviceName) = 0;
	...
	virtual Smart::IQueryServerPattern<CommRobotinoObjects::CommRobotinoIOValues, CommRobotinoObjects::CommRobotinoIOValues,SmartACE::QueryId> * createRobotinoIOValuesQueryServiceAnsw(const std::string &serviceName) = 0;
