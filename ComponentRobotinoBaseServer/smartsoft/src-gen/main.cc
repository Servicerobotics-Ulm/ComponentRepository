...
int main(int argc, char *argv[])
{
	...
	ComponentRobotinoBaseServer::instance()->init(argc, argv);
	// run component infrastructure until the component is commanded to shutdown
	ComponentRobotinoBaseServer::instance()->run();
	// clean-up component's internal resources (deleting ports, tasks, etc.)
	ComponentRobotinoBaseServer::instance()->fini();
	// destroy the component's singleton
	ComponentRobotinoBaseServer::deleteInstance();
