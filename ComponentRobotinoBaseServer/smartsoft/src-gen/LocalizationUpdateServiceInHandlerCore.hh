...
//--------------------------------------------------------------------------
#ifndef _LOCALIZATIONUPDATESERVICEINHANDLER_CORE_HH
#define _LOCALIZATIONUPDATESERVICEINHANDLER_CORE_HH
...
#include <LocalizationUpdateServiceInHandlerObserverInterface.hh>

class LocalizationUpdateServiceInHandlerCore
...
private:
	...
	std::list<LocalizationUpdateServiceInHandlerObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(LocalizationUpdateServiceInHandlerObserverInterface *observer);
	void detach_interaction_observer(LocalizationUpdateServiceInHandlerObserverInterface *observer);
	
protected:

public:
	LocalizationUpdateServiceInHandlerCore(
		Smart::InputSubject<CommBasicObjects::CommBasePositionUpdate> *subject,
		const int &prescaleFactor=1);
	virtual ~LocalizationUpdateServiceInHandlerCore();
};
#endif
