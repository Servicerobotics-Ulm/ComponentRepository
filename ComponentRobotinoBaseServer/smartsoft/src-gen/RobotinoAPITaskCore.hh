...
//--------------------------------------------------------------------------
#ifndef _ROBOTINOAPITASK_CORE_HH
#define _ROBOTINOAPITASK_CORE_HH
...
private:
	...
	std::list<RobotinoAPITaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(RobotinoAPITaskObserverInterface *observer);
	void detach_interaction_observer(RobotinoAPITaskObserverInterface *observer);

public:
	RobotinoAPITaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~RobotinoAPITaskCore();
