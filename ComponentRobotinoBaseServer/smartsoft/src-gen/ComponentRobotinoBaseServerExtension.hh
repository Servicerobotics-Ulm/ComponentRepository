...
#ifndef COMPONENTROBOTINOBASESERVER_EXTENSION_HH_
#define COMPONENTROBOTINOBASESERVER_EXTENSION_HH_
...
public:
	ComponentRobotinoBaseServerExtension(const std::string &name);
	virtual ~ComponentRobotinoBaseServerExtension();
...
#endif /* COMPONENTROBOTINOBASESERVER_EXTENSION_HH_ */
