...
#ifndef _IMAGEQUERYHANDLER_USER_HH
#define _IMAGEQUERYHANDLER_USER_HH
...
protected:
public:
	ImageQueryHandler(Smart::IQueryServerPattern<CommBasicObjects::CommVoid, DomainVision::CommVideoImage, SmartACE::QueryId>* server);
