# target configurations for ComponentUnicapImageServerROS1InterfacesExtension

# target configurations for ComponentUnicapImageServerROSExtension
IF(EXISTS ${ROS_DIR})
TARGET_LINK_LIBRARIES(${PROJECT_NAME} ${ROS_LIBS})
ENDIF(EXISTS ${ROS_DIR})

# target configurations for ComponentUnicapImageServerRestInterfacesExtension
...
# target configurations for PlainOpcUaComponentUnicapImageServerExtension
