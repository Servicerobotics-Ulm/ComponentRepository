...
#ifndef COMPONENTUNICAPIMAGESERVER_EXTENSION_HH_
#define COMPONENTUNICAPIMAGESERVER_EXTENSION_HH_
...
public:
	ComponentUnicapImageServerExtension(const std::string &name);
	virtual ~ComponentUnicapImageServerExtension();
...
#endif /* COMPONENTUNICAPIMAGESERVER_EXTENSION_HH_ */
