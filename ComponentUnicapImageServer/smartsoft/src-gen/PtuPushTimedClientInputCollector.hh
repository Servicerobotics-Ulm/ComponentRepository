...
//--------------------------------------------------------------------------
#ifndef _PTUPUSHTIMEDCLIENT_INPUT_COLLECTOR_HH
#define _PTUPUSHTIMEDCLIENT_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** PtuPushTimedClientInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort ptuPushTimedClient and at the same time acts itself
 ...
 */
class PtuPushTimedClientInputCollector
...
{
public:
	PtuPushTimedClientInputCollector(Smart::InputSubject<CommBasicObjects::CommDevicePoseState> *subject)
	:	Smart::IInputHandler<CommBasicObjects::CommDevicePoseState>(subject)
	{  }
	virtual ~PtuPushTimedClientInputCollector() = default;
...
#endif // _PTUPUSHTIMEDCLIENT_INPUT_COLLECTOR_HH
