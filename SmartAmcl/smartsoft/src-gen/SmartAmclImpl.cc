...
SmartAmclImpl::SmartAmclImpl(const std::string &componentName, int & argc, char ** argv)
:	SmartACE::SmartComponent(componentName, argc, argv)
{  }

SmartAmclImpl::SmartAmclImpl(const std::string &componentName, int & argc, char ** argv, const ACE_Sched_Params &sched_params)
:	SmartACE::SmartComponent(componentName, argc, argv, NULL, sched_params)
{  }

SmartAmclImpl::~SmartAmclImpl() 
{  }

int SmartAmclImpl::startComponentInfrastructure(void)
{
...
void SmartAmclImpl::stopComponentInfrastructure(const std::chrono::steady_clock::duration &timeoutTime)
{
	this->signalSmartTasksToStop(timeoutTime);
}
void SmartAmclImpl::cleanUpComponentResources()
{
