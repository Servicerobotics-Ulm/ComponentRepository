...
static SmartAmclAcePortFactory acePortFactory;

SmartAmclAcePortFactory::SmartAmclAcePortFactory()
{  
	componentImpl = 0;
	SmartAmcl::instance()->addPortFactory("ACE_SmartSoft", this);
}

SmartAmclAcePortFactory::~SmartAmclAcePortFactory()
{  }

void SmartAmclAcePortFactory::initialize(SmartAmcl *component, int argc, char* argv[])
{
	if(component->connections.component.defaultScheduler != "DEFAULT") {
		...
		componentImpl = new SmartAmclImpl(component->connections.component.name, argc, argv, sched_params);
	} else {
		// create new instance of the SmartSoft component
		componentImpl = new SmartAmclImpl(component->connections.component.name, argc, argv);
	}
}

int SmartAmclAcePortFactory::onStartup()
{
	return componentImpl->startComponentInfrastructure();
}

Smart::IPushClientPattern<CommBasicObjects::CommMobileLaserScan> * SmartAmclAcePortFactory::createLaserServiceIn()
{
	return new SmartACE::PushClient<CommBasicObjects::CommMobileLaserScan>(componentImpl);
}

Smart::ISendClientPattern<CommBasicObjects::CommBasePositionUpdate> * SmartAmclAcePortFactory::createLocalizationUpdateServiceOut()
{
...
SmartACE::SmartComponent* SmartAmclAcePortFactory::getComponentImpl()
{
	return componentImpl;
}

int SmartAmclAcePortFactory::onShutdown(const std::chrono::steady_clock::duration &timeoutTime)
{
	componentImpl->stopComponentInfrastructure(timeoutTime);
	return 0;
}

void SmartAmclAcePortFactory::destroy()
{
