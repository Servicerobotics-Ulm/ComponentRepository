...
#ifndef SMARTAMCL_OPC_UA_BACKEND_PORTFACTORY_HH_
#define SMARTAMCL_OPC_UA_BACKEND_PORTFACTORY_HH_
...
class SmartAmclOpcUaBackendPortFactory: public SmartAmclPortFactoryInterface
{
private:
	...
	int task_execution();
public:
	SmartAmclOpcUaBackendPortFactory();
	virtual ~SmartAmclOpcUaBackendPortFactory();
...
#endif /* SMARTAMCL_SERONET_SDK_PORTFACTORY_HH_ */
