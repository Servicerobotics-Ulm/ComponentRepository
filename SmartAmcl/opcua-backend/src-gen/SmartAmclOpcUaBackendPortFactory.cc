...
#include "SmartAmclOpcUaBackendPortFactory.hh"
...
SmartAmclOpcUaBackendPortFactory::SmartAmclOpcUaBackendPortFactory()
{  
	componentImpl = 0;
	SmartAmcl::instance()->addPortFactory("OpcUa_SeRoNet", this);
}

SmartAmclOpcUaBackendPortFactory::~SmartAmclOpcUaBackendPortFactory()
{  }

void SmartAmclOpcUaBackendPortFactory::initialize(SmartAmcl *component, int argc, char* argv[])
{
	componentImpl = new SeRoNet::Utils::Component(component->connections.component.name);
}

int SmartAmclOpcUaBackendPortFactory::onStartup()
{
	if (!component_thread.joinable()) {
    	component_thread = std::thread(&SmartAmclOpcUaBackendPortFactory::task_execution, this);
    	return 0;
    }
	return -1;
}

Smart::IPushClientPattern<CommBasicObjects::CommMobileLaserScan> * SmartAmclOpcUaBackendPortFactory::createLaserServiceIn()
{
	return new SeRoNet::OPCUA::Client::PushClient<CommBasicObjects::CommMobileLaserScan>(componentImpl);
}

Smart::ISendClientPattern<CommBasicObjects::CommBasePositionUpdate> * SmartAmclOpcUaBackendPortFactory::createLocalizationUpdateServiceOut()
{
...
int SmartAmclOpcUaBackendPortFactory::task_execution()
{
	componentImpl->run();
	return 0;
}

int SmartAmclOpcUaBackendPortFactory::onShutdown(const std::chrono::steady_clock::duration &timeoutTime)
{
...
void SmartAmclOpcUaBackendPortFactory::destroy()
{
