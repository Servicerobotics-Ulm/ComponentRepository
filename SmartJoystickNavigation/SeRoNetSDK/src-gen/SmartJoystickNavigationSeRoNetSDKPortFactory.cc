...
#include "SmartJoystickNavigationSeRoNetSDKPortFactory.hh"
...
static SmartJoystickNavigationSeRoNetSDKPortFactory SeRoNetSDKPortFactory;

SmartJoystickNavigationSeRoNetSDKPortFactory::SmartJoystickNavigationSeRoNetSDKPortFactory()
{  
	componentImpl = 0;
...
void SmartJoystickNavigationSeRoNetSDKPortFactory::initialize(SmartJoystickNavigation *component, int argc, char* argv[])
{
	componentImpl = new SeRoNet::Utils::Component(component->connections.component.name);
}

int SmartJoystickNavigationSeRoNetSDKPortFactory::onStartup()
{
	if (!component_thread.joinable()) {
    	component_thread = std::thread(&SmartJoystickNavigationSeRoNetSDKPortFactory::task_execution, this);
    	return 0;
    }
	return -1;
}

Smart::ISendClientPattern<CommBasicObjects::CommNavigationVelocity> * SmartJoystickNavigationSeRoNetSDKPortFactory::createNavVelServiceOut()
{
	return new SeRoNet::OPCUA::Client::SendClient<CommBasicObjects::CommNavigationVelocity>(componentImpl);
}

Smart::IPushClientPattern<CommBasicObjects::CommJoystick> * SmartJoystickNavigationSeRoNetSDKPortFactory::createJoystickServiceIn()
{
...
int SmartJoystickNavigationSeRoNetSDKPortFactory::task_execution()
{
	componentImpl->run();
	return 0;
}

int SmartJoystickNavigationSeRoNetSDKPortFactory::onShutdown(const std::chrono::steady_clock::duration &timeoutTime)
{
...
void SmartJoystickNavigationSeRoNetSDKPortFactory::destroy()
{
