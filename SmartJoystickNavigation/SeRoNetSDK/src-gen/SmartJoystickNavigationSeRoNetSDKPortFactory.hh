...
#ifndef SMARTJOYSTICKNAVIGATION_SERONET_SDK_PORTFACTORY_HH_
#define SMARTJOYSTICKNAVIGATION_SERONET_SDK_PORTFACTORY_HH_
...
class SmartJoystickNavigationSeRoNetSDKPortFactory: public SmartJoystickNavigationPortFactoryInterface
{
private:
	...
	int task_execution();
public:
	SmartJoystickNavigationSeRoNetSDKPortFactory();
	virtual ~SmartJoystickNavigationSeRoNetSDKPortFactory();
