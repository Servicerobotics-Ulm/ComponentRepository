...
#ifndef SMARTJOYSTICKNAVIGATION_EXTENSION_HH_
#define SMARTJOYSTICKNAVIGATION_EXTENSION_HH_
...
public:
	SmartJoystickNavigationExtension(const std::string &name);
	virtual ~SmartJoystickNavigationExtension();
...
#endif /* SMARTJOYSTICKNAVIGATION_EXTENSION_HH_ */
