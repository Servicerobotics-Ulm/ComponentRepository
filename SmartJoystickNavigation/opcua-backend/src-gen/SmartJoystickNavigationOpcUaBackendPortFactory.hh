...
#ifndef SMARTJOYSTICKNAVIGATION_OPC_UA_BACKEND_PORTFACTORY_HH_
#define SMARTJOYSTICKNAVIGATION_OPC_UA_BACKEND_PORTFACTORY_HH_
...
class SmartJoystickNavigationOpcUaBackendPortFactory: public SmartJoystickNavigationPortFactoryInterface
{
private:
	...
	int task_execution();
public:
	SmartJoystickNavigationOpcUaBackendPortFactory();
	virtual ~SmartJoystickNavigationOpcUaBackendPortFactory();
...
#endif /* SMARTJOYSTICKNAVIGATION_SERONET_SDK_PORTFACTORY_HH_ */
