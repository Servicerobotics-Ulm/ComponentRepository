...
#ifndef COMPONENTTTS_EXTENSION_HH_
#define COMPONENTTTS_EXTENSION_HH_
...
public:
	ComponentTTSExtension(const std::string &name);
	virtual ~ComponentTTSExtension();
...
#endif /* COMPONENTTTS_EXTENSION_HH_ */
