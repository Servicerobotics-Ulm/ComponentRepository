...
#ifndef COMPONENTFILEPROVIDER_EXTENSION_HH_
#define COMPONENTFILEPROVIDER_EXTENSION_HH_
...
public:
	ComponentFileProviderExtension(const std::string &name);
	virtual ~ComponentFileProviderExtension();
...
#endif /* COMPONENTFILEPROVIDER_EXTENSION_HH_ */
