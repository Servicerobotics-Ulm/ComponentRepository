...
//--------------------------------------------------------------------------
#ifndef _LASERSERVICEIN_INPUT_COLLECTOR_HH
#define _LASERSERVICEIN_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** LaserServiceInInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort LaserServiceIn and at the same time acts itself
 ...
 */
class LaserServiceInInputCollector
:	public Smart::IInputHandler<CommBasicObjects::CommMobileLaserScan>
,	public Smart::InputSubject<CommBasicObjects::CommMobileLaserScan>
{
public:
	LaserServiceInInputCollector(Smart::InputSubject<CommBasicObjects::CommMobileLaserScan> *subject)
	:	Smart::IInputHandler<CommBasicObjects::CommMobileLaserScan>(subject)
	{  }
	virtual ~LaserServiceInInputCollector() = default;
...
#endif // _LASERSERVICEIN_INPUT_COLLECTOR_HH
