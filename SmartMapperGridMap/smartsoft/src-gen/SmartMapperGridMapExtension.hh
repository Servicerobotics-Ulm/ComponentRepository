...
#ifndef SMARTMAPPERGRIDMAP_EXTENSION_HH_
#define SMARTMAPPERGRIDMAP_EXTENSION_HH_
...
public:
	SmartMapperGridMapExtension(const std::string &name);
	virtual ~SmartMapperGridMapExtension();
...
#endif /* SMARTMAPPERGRIDMAP_EXTENSION_HH_ */
