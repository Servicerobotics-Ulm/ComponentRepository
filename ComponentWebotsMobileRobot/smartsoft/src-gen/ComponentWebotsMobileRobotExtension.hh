...
#ifndef COMPONENTWEBOTSMOBILEROBOT_EXTENSION_HH_
#define COMPONENTWEBOTSMOBILEROBOT_EXTENSION_HH_
...
public:
	ComponentWebotsMobileRobotExtension(const std::string &name);
	virtual ~ComponentWebotsMobileRobotExtension();
...
#endif /* COMPONENTWEBOTSMOBILEROBOT_EXTENSION_HH_ */
