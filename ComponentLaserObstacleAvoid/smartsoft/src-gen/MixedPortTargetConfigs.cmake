# target configurations for ComponentLaserObstacleAvoidROS1InterfacesExtension

# target configurations for ComponentLaserObstacleAvoidROSExtension
IF(EXISTS ${ROS_DIR})
TARGET_LINK_LIBRARIES(${PROJECT_NAME} ${ROS_LIBS})
ENDIF(EXISTS ${ROS_DIR})

# target configurations for ComponentLaserObstacleAvoidRestInterfacesExtension
...
# target configurations for PlainOpcUaComponentLaserObstacleAvoidExtension
