...
#ifndef COMPONENTLASEROBSTACLEAVOID_EXTENSION_HH_
#define COMPONENTLASEROBSTACLEAVOID_EXTENSION_HH_
...
public:
	ComponentLaserObstacleAvoidExtension(const std::string &name);
	virtual ~ComponentLaserObstacleAvoidExtension();
...
#endif /* COMPONENTLASEROBSTACLEAVOID_EXTENSION_HH_ */
