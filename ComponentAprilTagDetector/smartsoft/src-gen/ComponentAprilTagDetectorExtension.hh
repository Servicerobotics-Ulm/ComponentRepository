...
#ifndef COMPONENTAPRILTAGDETECTOR_EXTENSION_HH_
#define COMPONENTAPRILTAGDETECTOR_EXTENSION_HH_
...
public:
	ComponentAprilTagDetectorExtension(const std::string &name);
	virtual ~ComponentAprilTagDetectorExtension();
...
#endif /* COMPONENTAPRILTAGDETECTOR_EXTENSION_HH_ */
