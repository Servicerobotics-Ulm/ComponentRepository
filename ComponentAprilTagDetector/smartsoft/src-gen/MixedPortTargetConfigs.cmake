# target configurations for ComponentAprilTagDetectorROS1InterfacesExtension

# target configurations for ComponentAprilTagDetectorROSExtension
IF(EXISTS ${ROS_DIR})
TARGET_LINK_LIBRARIES(${PROJECT_NAME} ${ROS_LIBS})
ENDIF(EXISTS ${ROS_DIR})

# target configurations for ComponentAprilTagDetectorRestInterfacesExtension
...
# target configurations for PlainOpcUaComponentAprilTagDetectorExtension
