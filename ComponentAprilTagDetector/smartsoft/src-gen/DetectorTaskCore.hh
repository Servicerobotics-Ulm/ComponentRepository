...
//--------------------------------------------------------------------------
#ifndef _DETECTORTASK_CORE_HH
#define _DETECTORTASK_CORE_HH
...
#include <DetectorTaskObserverInterface.hh>


class DetectorTaskCore
...
protected:
	...
	Smart::StatusCode markerListDetectionServiceOutPut(CommTrackingObjects::CommDetectedMarkerList &markerListDetectionServiceOutDataObject);
	// this method is meant to be used in derived classes
	Smart::StatusCode markerListEventServiceOutPut(CommTrackingObjects::CommDetectedMarkerEventState &eventState);
	// this method is meant to be used in derived classes
...
private:
	...
	std::list<DetectorTaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(DetectorTaskObserverInterface *observer);
	void detach_interaction_observer(DetectorTaskObserverInterface *observer);

public:
	DetectorTaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~DetectorTaskCore();
