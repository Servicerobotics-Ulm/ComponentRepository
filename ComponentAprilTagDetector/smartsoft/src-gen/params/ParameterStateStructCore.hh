...
public:
		...
		public:
			...
			void to_ostream(std::ostream &os = std::cout) const
			{
				os << "options(";
				os << "debug = " << debug; os << ", ";
				os << "decimate = " << decimate; os << ", ";
				os << "decision_threshold = " << decision_threshold; os << ", ";
				os << "numThreads = " << numThreads; os << ", ";
				os << "refine_edges = " << refine_edges; os << ", ";
				os << "sigma = " << sigma; os << ", ";
				os << "tag_family = " << tag_family; os << ", ";
