...
//--------------------------------------------------------------------------
#ifndef _RGBIMAGEPUSHSERVICEIN_INPUT_COLLECTOR_HH
#define _RGBIMAGEPUSHSERVICEIN_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** RGBImagePushServiceInInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort RGBImagePushServiceIn and at the same time acts itself
 ...
 */
class RGBImagePushServiceInInputCollector
:	public Smart::IInputHandler<DomainVision::CommVideoImage>
,	public Smart::InputSubject<DomainVision::CommVideoImage>
{
public:
	RGBImagePushServiceInInputCollector(Smart::InputSubject<DomainVision::CommVideoImage> *subject)
	:	Smart::IInputHandler<DomainVision::CommVideoImage>(subject)
	{  }
	virtual ~RGBImagePushServiceInInputCollector() = default;
...
#endif // _RGBIMAGEPUSHSERVICEIN_INPUT_COLLECTOR_HH
