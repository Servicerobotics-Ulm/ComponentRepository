...
//-------------------------------------------------------------------------
#ifndef _MARKERLISTEVENTSERVICEOUT_EVENT_TEST_HANDLER_USER_HH
#define _MARKERLISTEVENTSERVICEOUT_EVENT_TEST_HANDLER_USER_HH
		
#include "MarkerListEventServiceOutEventTestHandlerCore.hh"

class MarkerListEventServiceOutEventTestHandler : public MarkerListEventServiceOutEventTestHandlerCore
{
public:
