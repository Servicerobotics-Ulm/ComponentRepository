...
#ifndef COMPONENTWEBOTS2DLIDAR_EXTENSION_HH_
#define COMPONENTWEBOTS2DLIDAR_EXTENSION_HH_
...
public:
	ComponentWebots2DLidarExtension(const std::string &name);
	virtual ~ComponentWebots2DLidarExtension();
...
#endif /* COMPONENTWEBOTS2DLIDAR_EXTENSION_HH_ */
