...
public:
	...
	virtual void handleCommManipulationPlannerObjects_ManipulationPlannerParameter_OPENRAVE_GRASPOBJ(const int &objectID);
	virtual void handleCommManipulationPlannerObjects_ManipulationPlannerParameter_OPENRAVE_RELEASEOBJ(const int &objectID);
