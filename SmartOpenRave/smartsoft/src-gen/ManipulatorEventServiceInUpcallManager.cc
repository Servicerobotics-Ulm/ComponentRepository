...
ManipulatorEventServiceInUpcallManager::ManipulatorEventServiceInUpcallManager(
	...
	:	Smart::IInputHandler<Smart::EventInputType<CommManipulatorObjects::CommManipulatorEventResult,SmartACE::EventId>>(subject, prescaleFactor)
{  }
ManipulatorEventServiceInUpcallManager::~ManipulatorEventServiceInUpcallManager()
{  }

void ManipulatorEventServiceInUpcallManager::notify_upcalls(const Smart::EventInputType<CommManipulatorObjects::CommManipulatorEventResult,SmartACE::EventId> &input)
{
