...
SmartOpenRaveImpl::SmartOpenRaveImpl(const std::string &componentName, int & argc, char ** argv)
:	SmartACE::SmartComponent(componentName, argc, argv)
{  }

SmartOpenRaveImpl::SmartOpenRaveImpl(const std::string &componentName, int & argc, char ** argv, const ACE_Sched_Params &sched_params)
:	SmartACE::SmartComponent(componentName, argc, argv, NULL, sched_params)
{  }

SmartOpenRaveImpl::~SmartOpenRaveImpl() 
{  }

int SmartOpenRaveImpl::startComponentInfrastructure(void)
{
...
void SmartOpenRaveImpl::stopComponentInfrastructure(const std::chrono::steady_clock::duration &timeoutTime)
{
	this->signalSmartTasksToStop(timeoutTime);
}
void SmartOpenRaveImpl::cleanUpComponentResources()
{
