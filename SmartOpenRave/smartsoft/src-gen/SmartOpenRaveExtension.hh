...
#ifndef SMARTOPENRAVE_EXTENSION_HH_
#define SMARTOPENRAVE_EXTENSION_HH_
...
public:
	SmartOpenRaveExtension(const std::string &name);
	virtual ~SmartOpenRaveExtension();
...
#endif /* SMARTOPENRAVE_EXTENSION_HH_ */
