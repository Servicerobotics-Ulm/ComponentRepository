...
void ParamUpdateHandler::loadParameter(SmartACE::SmartIniParameter &parameter)
{
	...
	try
	{
		...
		//
		// parameter Settings
		if(parameter.getBoolean("Settings", "connectChainedEntries", commitState.Settings.connectChainedEntries))
		{
			globalState.Settings.connectChainedEntries = commitState.Settings.connectChainedEntries;
		}
