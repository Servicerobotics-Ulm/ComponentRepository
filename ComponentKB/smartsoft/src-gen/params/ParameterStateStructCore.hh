...
public:
		...
		protected:
			 ...
			 */
			bool connectChainedEntries;
		
		public:
			// default constructor
			SettingsType() {
				connectChainedEntries = false;
			}
		
			/**
			 * here are the public getters
			 */
			inline bool getConnectChainedEntries() const { return connectChainedEntries; }
			
			void to_ostream(std::ostream &os = std::cout) const
			{
				os << "Settings(";
				os << "connectChainedEntries = " << connectChainedEntries << ", ";
				os << ")\n";
			}
...
public:
	...
	std::string getAsJSONString() {
		...
		param["Settings"] = nlohmann::json {
			{"connectChainedEntries" , getSettings().getConnectChainedEntries()}
		};
