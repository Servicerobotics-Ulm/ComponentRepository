...
#ifndef COMPONENTKB_EXTENSION_HH_
#define COMPONENTKB_EXTENSION_HH_
...
public:
	ComponentKBExtension(const std::string &name);
	virtual ~ComponentKBExtension();
...
#endif /* COMPONENTKB_EXTENSION_HH_ */
