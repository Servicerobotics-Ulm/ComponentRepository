# target configurations for ComponentKBROS1InterfacesExtension

# target configurations for ComponentKBROSExtension
IF(EXISTS ${ROS_DIR})
TARGET_LINK_LIBRARIES(${PROJECT_NAME} ${ROS_LIBS})
ENDIF(EXISTS ${ROS_DIR})

# target configurations for ComponentKBRestInterfacesExtension
...
# target configurations for PlainOpcUaComponentKBExtension
