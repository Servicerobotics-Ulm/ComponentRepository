...
inline std::ostream& operator<<(std::ostream &os, const scanCfg& cfg )
{
  return os <<"Scanning frequency: "<<cfg.scaningFrequency << " Scanning resolution: "<<cfg.angleResolution<<
		  	  "Start angle: "<<cfg.startAngle<<" Stop angle: "<<cfg.stopAngle<<std::endl;
}
