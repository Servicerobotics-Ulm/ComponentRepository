...
#ifndef COMPONENTLASERLMS1XX_EXTENSION_HH_
#define COMPONENTLASERLMS1XX_EXTENSION_HH_
...
public:
	ComponentLaserLMS1xxExtension(const std::string &name);
	virtual ~ComponentLaserLMS1xxExtension();
...
#endif /* COMPONENTLASERLMS1XX_EXTENSION_HH_ */
