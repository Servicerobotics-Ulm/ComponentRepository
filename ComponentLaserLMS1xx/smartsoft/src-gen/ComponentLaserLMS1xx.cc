...
#include "ComponentLaserLMS1xxAcePortFactory.hh"


// initialize static singleton pointer to zero
ComponentLaserLMS1xx* ComponentLaserLMS1xx::_componentLaserLMS1xx = 0;

// constructor
ComponentLaserLMS1xx::ComponentLaserLMS1xx()
{
	std::cout << "constructor of ComponentLaserLMS1xx\n";
	...
	connections.component.name = "ComponentLaserLMS1xx";
...
void ComponentLaserLMS1xx::addPortFactory(const std::string &name, ComponentLaserLMS1xxPortFactoryInterface *portFactory)
{
	portFactoryRegistry[name] = portFactory;
}

void ComponentLaserLMS1xx::addExtension(ComponentLaserLMS1xxExtension *extension)
{
	componentExtensionRegistry[extension->getName()] = extension;
}

SmartACE::SmartComponent* ComponentLaserLMS1xx::getComponentImpl()
{
	return dynamic_cast<ComponentLaserLMS1xxAcePortFactory*>(portFactoryRegistry["ACE_SmartSoft"])->getComponentImpl();
}
 ...
 */
void ComponentLaserLMS1xx::setStartupFinished() {
	stateSlave->setWaitState("Alive");
	std::cout << "ComponentDefinition initialization/startup finished." << std::endl;
}


Smart::StatusCode ComponentLaserLMS1xx::connectBaseStateServiceIn(const std::string &serverName, const std::string &serviceName) {
 ...
 */
Smart::StatusCode ComponentLaserLMS1xx::connectAndStartAllServices() {
 ...
 */
void ComponentLaserLMS1xx::startAllTasks() {
 ...
 */
void ComponentLaserLMS1xx::startAllTimers() {
}


Smart::TaskTriggerSubject* ComponentLaserLMS1xx::getInputTaskTriggerFromString(const std::string &client)
{
...
void ComponentLaserLMS1xx::init(int argc, char *argv[])
{
	try {
		Smart::StatusCode status;
		...
		ComponentLaserLMS1xxPortFactoryInterface *acePortFactory = portFactoryRegistry["ACE_SmartSoft"];
		if(acePortFactory == 0) {
		...
		SmartACE::SmartComponent *component = dynamic_cast<ComponentLaserLMS1xxAcePortFactory*>(acePortFactory)->getComponentImpl();
		
		std::cout << "ComponentDefinition ComponentLaserLMS1xx is named " << connections.component.name << std::endl;
...
void ComponentLaserLMS1xx::fini()
{
...
void ComponentLaserLMS1xx::loadParameter(int argc, char *argv[])
{
	/*
	...
	try
	{
		...
		} else if(parameter.searchFile("ComponentLaserLMS1xx.ini", parameterfile)) {
			parameterFileFound = true;
			std::cout << "load ComponentLaserLMS1xx.ini parameter file\n";
			parameter.addFile(parameterfile);
		} else {
			std::cout << "WARNING: ComponentLaserLMS1xx.ini parameter file not found! (using default values or command line arguments)\n";
		}
