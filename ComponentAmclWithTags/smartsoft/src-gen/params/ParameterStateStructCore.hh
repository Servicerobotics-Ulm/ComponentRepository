...
public:
		...
		/**
		 * Definition of Parameter VisualTag
		 */
		class VisualTagType 
		{
			friend class ParamUpdateHandler;
		...
		public:
			// default constructor
			VisualTagType() {
				distance_variance = 0.0069;
				orientation_variance = 0.0076;
			}
		
			/**
			 * here are the public getters
			 */
			inline double getDistance_variance() const { return distance_variance; }
			inline double getOrientation_variance() const { return orientation_variance; }
		...
		public:
			...
			inline unsigned short getSensors_to_use() const { return sensors_to_use; }
			inline std::string getTag_file() const { return tag_file; }
...
public:
	...
	VisualTagType getVisualTag() const {
		return VisualTag;
	}
	...
	std::string getAsJSONString() {
		...
		param["General"] = nlohmann::json {
			...
			{"sensors_to_use" , getGeneral().getSensors_to_use()},
			{"tag_file" , getGeneral().getTag_file()},
		...
		param["VisualTag"] = nlohmann::json {
			{"distance_variance" , getVisualTag().getDistance_variance()},
			{"orientation_variance" , getVisualTag().getOrientation_variance()}
		};
