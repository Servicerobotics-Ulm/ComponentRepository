...
void ParamUpdateHandler::loadParameter(SmartACE::SmartIniParameter &parameter)
{
	...
	try
	{
		...
		if(parameter.getInteger("General", "sensors_to_use", commitState.General.sensors_to_use))
		{
			globalState.General.sensors_to_use = commitState.General.sensors_to_use;
		}
		if(parameter.getString("General", "tag_file", commitState.General.tag_file))
		{
			globalState.General.tag_file = commitState.General.tag_file;
		}
		...
		// parameter VisualTag
		if(parameter.getDouble("VisualTag", "distance_variance", commitState.VisualTag.distance_variance))
		{
			globalState.VisualTag.distance_variance = commitState.VisualTag.distance_variance;
		}
		if(parameter.getDouble("VisualTag", "orientation_variance", commitState.VisualTag.orientation_variance))
		{
			globalState.VisualTag.orientation_variance = commitState.VisualTag.orientation_variance;
		}
