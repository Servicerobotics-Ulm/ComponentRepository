# target configurations for ComponentAmclWithTagsROS1InterfacesExtension

# target configurations for ComponentAmclWithTagsROSExtension
IF(EXISTS ${ROS_DIR})
TARGET_LINK_LIBRARIES(${PROJECT_NAME} ${ROS_LIBS})
ENDIF(EXISTS ${ROS_DIR})

# target configurations for ComponentAmclWithTagsRestInterfacesExtension
...
# target configurations for PlainOpcUaComponentAmclWithTagsExtension
