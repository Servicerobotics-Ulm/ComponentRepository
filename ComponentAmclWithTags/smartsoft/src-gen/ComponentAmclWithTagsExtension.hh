...
#ifndef COMPONENTAMCLWITHTAGS_EXTENSION_HH_
#define COMPONENTAMCLWITHTAGS_EXTENSION_HH_
...
public:
	ComponentAmclWithTagsExtension(const std::string &name);
	virtual ~ComponentAmclWithTagsExtension();
...
#endif /* COMPONENTAMCLWITHTAGS_EXTENSION_HH_ */
