...
#ifndef COMPONENTAMCLWITHTAGS_OPC_UA_BACKEND_PORTFACTORY_HH_
#define COMPONENTAMCLWITHTAGS_OPC_UA_BACKEND_PORTFACTORY_HH_
...
class ComponentAmclWithTagsOpcUaBackendPortFactory: public ComponentAmclWithTagsPortFactoryInterface
{
private:
	...
	int task_execution();
public:
	ComponentAmclWithTagsOpcUaBackendPortFactory();
	virtual ~ComponentAmclWithTagsOpcUaBackendPortFactory();
...
#endif /* COMPONENTAMCLWITHTAGS_SERONET_SDK_PORTFACTORY_HH_ */
