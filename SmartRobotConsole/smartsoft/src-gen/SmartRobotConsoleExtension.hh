...
#ifndef SMARTROBOTCONSOLE_EXTENSION_HH_
#define SMARTROBOTCONSOLE_EXTENSION_HH_
...
public:
	SmartRobotConsoleExtension(const std::string &name);
	virtual ~SmartRobotConsoleExtension();
...
#endif /* SMARTROBOTCONSOLE_EXTENSION_HH_ */
