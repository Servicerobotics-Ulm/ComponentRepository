...
#ifndef COMPONENTOPCUALASER_EXTENSION_HH_
#define COMPONENTOPCUALASER_EXTENSION_HH_
...
public:
	ComponentOPCUALaserExtension(const std::string &name);
	virtual ~ComponentOPCUALaserExtension();
...
#endif /* COMPONENTOPCUALASER_EXTENSION_HH_ */
