# target configurations for ComponentOPCUALaserROS1InterfacesExtension

# target configurations for ComponentOPCUALaserROSExtension
IF(EXISTS ${ROS_DIR})
TARGET_LINK_LIBRARIES(${PROJECT_NAME} ${ROS_LIBS})
ENDIF(EXISTS ${ROS_DIR})

# target configurations for ComponentOPCUALaserRestInterfacesExtension
...
# target configurations for PlainOpcUaComponentOPCUALaserExtension
