...
//--------------------------------------------------------------------------
#ifndef _COMPONENTOPCUALASER_HH
#define _COMPONENTOPCUALASER_HH

#include <map>
#include <iostream>
#include "aceSmartSoft.hh"
#include "smartQueryServerTaskTrigger_T.h"
#include "ComponentOPCUALaserCore.hh"

#include "ComponentOPCUALaserPortFactoryInterface.hh"
#include "ComponentOPCUALaserExtension.hh"
...
class ComponentOPCUALaser : public ComponentOPCUALaserCore {
private:
	static ComponentOPCUALaser *_componentOPCUALaser;
	
	// constructor
	ComponentOPCUALaser();
	
	// copy-constructor
	ComponentOPCUALaser(const ComponentOPCUALaser& cc);
	...
	std::map<std::string, ComponentOPCUALaserPortFactoryInterface*> portFactoryRegistry;
	
	// internal map storing various extensions of this component class
	std::map<std::string, ComponentOPCUALaserExtension*> componentExtensionRegistry;
...
public:
	...
	void addPortFactory(const std::string &name, ComponentOPCUALaserPortFactoryInterface *portFactory);
	
	SmartACE::SmartComponent* getComponentImpl();
	
	/// this method is used to register different component-extension classes
	void addExtension(ComponentOPCUALaserExtension *extension);
	...
	static ComponentOPCUALaser* instance()
	{
		if(_componentOPCUALaser == 0) {
			_componentOPCUALaser = new ComponentOPCUALaser();
		}
		return _componentOPCUALaser;
	}
	
	static void deleteInstance() {
		if(_componentOPCUALaser != 0) {
			delete _componentOPCUALaser;
		}
	}
