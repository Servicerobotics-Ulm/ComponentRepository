...
#ifndef COMPONENTOPCUALASER_PORTFACTORYINTERFACE_HH_
#define COMPONENTOPCUALASER_PORTFACTORYINTERFACE_HH_
...
// forward declaration
class ComponentOPCUALaser;

class ComponentOPCUALaserPortFactoryInterface {
public:
	ComponentOPCUALaserPortFactoryInterface() { };
	virtual ~ComponentOPCUALaserPortFactoryInterface() { };

	virtual void initialize(ComponentOPCUALaser *component, int argc, char* argv[]) = 0;
...
#endif /* COMPONENTOPCUALASER_PORTFACTORYINTERFACE_HH_ */
