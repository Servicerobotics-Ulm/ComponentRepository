...
void CompHandler::onStartup() 
{
	...
	// connect to all services
		if (COMP->getGlobalState().getBase_manipulator().getOn_base()) {
			...
			std::cout << "connected.\n";
			COMP->baseStateServiceIn->subscribe(COMP->connections.baseStateServiceIn.interval);
		}

		//if (COMP->getGlobalState().getServices().getActive_push_timed()) {
		//	COMP->laserPushTimedServer->start();
		//} ? GAUTAM no need to start the activity
