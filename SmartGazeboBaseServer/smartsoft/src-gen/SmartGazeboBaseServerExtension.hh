...
#ifndef SMARTGAZEBOBASESERVER_EXTENSION_HH_
#define SMARTGAZEBOBASESERVER_EXTENSION_HH_
...
public:
	SmartGazeboBaseServerExtension(const std::string &name);
	virtual ~SmartGazeboBaseServerExtension();
...
#endif /* SMARTGAZEBOBASESERVER_EXTENSION_HH_ */
