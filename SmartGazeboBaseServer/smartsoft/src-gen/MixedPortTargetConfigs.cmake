...
# target configurations for PlainOpcUaSmartGazeboBaseServerExtension
...
# target configurations for SmartGazeboBaseServerROS1InterfacesExtension

# target configurations for SmartGazeboBaseServerROSExtension
IF(EXISTS ${ROS_DIR})
TARGET_LINK_LIBRARIES(${PROJECT_NAME} ${ROS_LIBS})
ENDIF(EXISTS ${ROS_DIR})

# target configurations for SmartGazeboBaseServerRestInterfacesExtension
