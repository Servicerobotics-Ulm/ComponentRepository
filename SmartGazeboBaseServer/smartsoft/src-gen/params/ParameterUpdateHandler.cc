...
void ParamUpdateHandler::loadParameter(SmartACE::SmartIniParameter &parameter)
{
	...
	try
	{
		...
		//
		// parameter Settings
		if(parameter.getString("Settings", "basePoseTopic", commitState.Settings.basePoseTopic))
		{
			globalState.Settings.basePoseTopic = commitState.Settings.basePoseTopic;
		}
		if(parameter.getString("Settings", "baseVelTopic", commitState.Settings.baseVelTopic))
		{
			globalState.Settings.baseVelTopic = commitState.Settings.baseVelTopic;
		}
		if(parameter.getString("Settings", "laserTopic", commitState.Settings.laserTopic))
		{
			globalState.Settings.laserTopic = commitState.Settings.laserTopic;
		}
		if(parameter.getString("Settings", "sendVelTopic", commitState.Settings.sendVelTopic))
		{
			globalState.Settings.sendVelTopic = commitState.Settings.sendVelTopic;
		}
