...
//--------------------------------------------------------------------------
#ifndef _NAVVELSERVICEIN_INPUT_COLLECTOR_HH
#define _NAVVELSERVICEIN_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** NavVelServiceInInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort NavVelServiceIn and at the same time acts itself
 ...
 */
class NavVelServiceInInputCollector
...
{
public:
	NavVelServiceInInputCollector(Smart::InputSubject<CommBasicObjects::CommNavigationVelocity> *subject)
	:	Smart::IInputHandler<CommBasicObjects::CommNavigationVelocity>(subject)
	{  }
	virtual ~NavVelServiceInInputCollector() = default;
...
#endif // _NAVVELSERVICEIN_INPUT_COLLECTOR_HH
