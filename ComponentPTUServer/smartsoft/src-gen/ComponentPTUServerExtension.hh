...
#ifndef COMPONENTPTUSERVER_EXTENSION_HH_
#define COMPONENTPTUSERVER_EXTENSION_HH_
...
public:
	ComponentPTUServerExtension(const std::string &name);
	virtual ~ComponentPTUServerExtension();
...
#endif /* COMPONENTPTUSERVER_EXTENSION_HH_ */
