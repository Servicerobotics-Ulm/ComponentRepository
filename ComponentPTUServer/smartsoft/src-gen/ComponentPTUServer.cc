...
ComponentPTUServer* ComponentPTUServer::_componentPTUServer = 0;

// constructor
ComponentPTUServer::ComponentPTUServer()
{
	std::cout << "constructor of ComponentPTUServer\n";
	
	// set all pointer members to NULL
	baseStateTask = NULL;
	baseStateTaskTrigger = NULL;
	//componentPTUServerParams = NULL;
	...
	connections.component.name = "ComponentPTUServer";
...
void ComponentPTUServer::addPortFactory(const std::string &name, ComponentPTUServerPortFactoryInterface *portFactory)
{
	portFactoryRegistry[name] = portFactory;
}

void ComponentPTUServer::addExtension(ComponentPTUServerExtension *extension)
{
	componentExtensionRegistry[extension->getName()] = extension;
}

SmartACE::SmartComponent* ComponentPTUServer::getComponentImpl()
{
	return dynamic_cast<ComponentPTUServerAcePortFactory*>(portFactoryRegistry["ACE_SmartSoft"])->getComponentImpl();
}
 ...
 */
void ComponentPTUServer::setStartupFinished() {
	stateSlave->setWaitState("Alive");
	std::cout << "ComponentDefinition initialization/startup finished." << std::endl;
}


Smart::StatusCode ComponentPTUServer::connectBaseStateClient(const std::string &serverName, const std::string &serviceName) {
...
Smart::StatusCode ComponentPTUServer::connectBaseStateQueryClient(const std::string &serverName, const std::string &serviceName) {
	Smart::StatusCode status;
 ...
 */
Smart::StatusCode ComponentPTUServer::connectAndStartAllServices() {
 ...
 */
void ComponentPTUServer::startAllTasks() {
 ...
 */
void ComponentPTUServer::startAllTimers() {
}


Smart::TaskTriggerSubject* ComponentPTUServer::getInputTaskTriggerFromString(const std::string &client)
{
...
void ComponentPTUServer::init(int argc, char *argv[])
{
	try {
		Smart::StatusCode status;
		...
		ComponentPTUServerPortFactoryInterface *acePortFactory = portFactoryRegistry["ACE_SmartSoft"];
		if(acePortFactory == 0) {
		...
		SmartACE::SmartComponent *component = dynamic_cast<ComponentPTUServerAcePortFactory*>(acePortFactory)->getComponentImpl();
		
		std::cout << "ComponentDefinition ComponentPTUServer is named " << connections.component.name << std::endl;
...
void ComponentPTUServer::loadParameter(int argc, char *argv[])
{
	/*
	...
	try
	{
		...
		} else if(parameter.searchFile("ComponentPTUServer.ini", parameterfile)) {
			parameterFileFound = true;
			std::cout << "load ComponentPTUServer.ini parameter file\n";
			parameter.addFile(parameterfile);
		} else {
			std::cout << "WARNING: ComponentPTUServer.ini parameter file not found! (using default values or command line arguments)\n";
		}
