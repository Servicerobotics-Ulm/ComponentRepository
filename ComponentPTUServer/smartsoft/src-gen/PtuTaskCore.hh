...
//--------------------------------------------------------------------------
#ifndef _PTUTASK_CORE_HH
#define _PTUTASK_CORE_HH
...
#include <PtuTaskObserverInterface.hh>
...
protected:
	...
	Smart::StatusCode goalEventServerPut(DomainPTU::PTUGoalEventState &eventState);
...
private:
	...
	std::list<PtuTaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(PtuTaskObserverInterface *observer);
	void detach_interaction_observer(PtuTaskObserverInterface *observer);

public:
	PtuTaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~PtuTaskCore();
