...
//--------------------------------------------------------------------------
#ifndef _COMPONENTPTUSERVER_HH
#define _COMPONENTPTUSERVER_HH

#include <map>
#include <iostream>
#include "aceSmartSoft.hh"
#include "smartQueryServerTaskTrigger_T.h"
#include "ComponentPTUServerCore.hh"

#include "ComponentPTUServerPortFactoryInterface.hh"
#include "ComponentPTUServerExtension.hh"

// forward declarations
class ComponentPTUServerPortFactoryInterface;
class ComponentPTUServerExtension;

// includes for PlainOpcUaComponentPTUServerExtension
...
#define COMP ComponentPTUServer::instance()

class ComponentPTUServer : public ComponentPTUServerCore {
private:
	static ComponentPTUServer *_componentPTUServer;
	
	// constructor
	ComponentPTUServer();
	
	// copy-constructor
	ComponentPTUServer(const ComponentPTUServer& cc);
	...
	std::map<std::string, ComponentPTUServerPortFactoryInterface*> portFactoryRegistry;
	
	// internal map storing various extensions of this component class
	std::map<std::string, ComponentPTUServerExtension*> componentExtensionRegistry;
...
public:
	...
	void addPortFactory(const std::string &name, ComponentPTUServerPortFactoryInterface *portFactory);
	
	SmartACE::SmartComponent* getComponentImpl();
	
	/// this method is used to register different component-extension classes
	void addExtension(ComponentPTUServerExtension *extension);
	...
	static ComponentPTUServer* instance()
	{
		if(_componentPTUServer == 0) {
			_componentPTUServer = new ComponentPTUServer();
		}
		return _componentPTUServer;
	}
	
	static void deleteInstance() {
		if(_componentPTUServer != 0) {
			delete _componentPTUServer;
		}
	}
