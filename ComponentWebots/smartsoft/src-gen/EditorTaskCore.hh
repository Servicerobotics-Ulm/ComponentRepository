...
//--------------------------------------------------------------------------
#ifndef _EDITORTASK_CORE_HH
#define _EDITORTASK_CORE_HH
...
#include <EditorTaskObserverInterface.hh>


class EditorTaskCore
...
protected:
	...
	Smart::StatusCode navPathServiceOutPut(DomainRobotFleetNavigation::CommNavPath &navPathServiceOutDataObject);
...
private:
	...
	std::list<EditorTaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(EditorTaskObserverInterface *observer);
	void detach_interaction_observer(EditorTaskObserverInterface *observer);

public:
	EditorTaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~EditorTaskCore();
