# target configurations for ComponentWebotsConveyorBeltOpcuaROS1InterfacesExtension

# target configurations for ComponentWebotsConveyorBeltOpcuaROSExtension
IF(EXISTS ${ROS_DIR})
TARGET_LINK_LIBRARIES(${PROJECT_NAME} ${ROS_LIBS})
ENDIF(EXISTS ${ROS_DIR})

# target configurations for ComponentWebotsConveyorBeltOpcuaRestInterfacesExtension
...
# target configurations for PlainOpcUaComponentWebotsConveyorBeltOpcuaExtension
