...
int main(int argc, char *argv[])
{
	...
	ComponentWebotsConveyorBeltOpcua::instance()->init(argc, argv);
	// run component infrastructure until the component is commanded to shutdown
	ComponentWebotsConveyorBeltOpcua::instance()->run();
	// clean-up component's internal resources (deleting ports, tasks, etc.)
	ComponentWebotsConveyorBeltOpcua::instance()->fini();
	// destroy the component's singleton
	ComponentWebotsConveyorBeltOpcua::deleteInstance();
