...
#ifndef COMPONENTFILEMOVER_EXTENSION_HH_
#define COMPONENTFILEMOVER_EXTENSION_HH_
...
public:
	ComponentFileMoverExtension(const std::string &name);
	virtual ~ComponentFileMoverExtension();
...
#endif /* COMPONENTFILEMOVER_EXTENSION_HH_ */
