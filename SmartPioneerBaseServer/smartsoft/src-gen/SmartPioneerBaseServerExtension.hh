...
#ifndef SMARTPIONEERBASESERVER_EXTENSION_HH_
#define SMARTPIONEERBASESERVER_EXTENSION_HH_
...
public:
	SmartPioneerBaseServerExtension(const std::string &name);
	virtual ~SmartPioneerBaseServerExtension();
...
#endif /* SMARTPIONEERBASESERVER_EXTENSION_HH_ */
