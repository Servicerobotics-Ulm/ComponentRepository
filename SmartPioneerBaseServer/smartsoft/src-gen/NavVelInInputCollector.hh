...
//--------------------------------------------------------------------------
#ifndef _NAVVELIN_INPUT_COLLECTOR_HH
#define _NAVVELIN_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** NavVelInInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort NavVelIn and at the same time acts itself
...
{
public:
	NavVelInInputCollector(Smart::InputSubject<CommBasicObjects::CommNavigationVelocity> *subject)
	:	Smart::IInputHandler<CommBasicObjects::CommNavigationVelocity>(subject)
	{  }
	virtual ~NavVelInInputCollector() = default;
...
#endif // _NAVVELIN_INPUT_COLLECTOR_HH
