...
#include "SmartURServerLegacyOpcUaBackendPortFactory.hh"
...
static SmartURServerLegacyOpcUaBackendPortFactory OpcUaBackendPortFactory;

SmartURServerLegacyOpcUaBackendPortFactory::SmartURServerLegacyOpcUaBackendPortFactory()
{  
	componentImpl = 0;
	SmartURServerLegacy::instance()->addPortFactory("OpcUa_SeRoNet", this);
}

SmartURServerLegacyOpcUaBackendPortFactory::~SmartURServerLegacyOpcUaBackendPortFactory()
{  }

void SmartURServerLegacyOpcUaBackendPortFactory::initialize(SmartURServerLegacy *component, int argc, char* argv[])
{
	componentImpl = new SeRoNet::Utils::Component(component->connections.component.name);
}

int SmartURServerLegacyOpcUaBackendPortFactory::onStartup()
{
	if (!component_thread.joinable()) {
    	component_thread = std::thread(&SmartURServerLegacyOpcUaBackendPortFactory::task_execution, this);
    	return 0;
    }
	return -1;
}

Smart::IPushClientPattern<CommBasicObjects::CommBaseState> * SmartURServerLegacyOpcUaBackendPortFactory::createBaseStateServiceIn()
{
	return new SeRoNet::OPCUA::Client::PushClient<CommBasicObjects::CommBaseState>(componentImpl);
}


Smart::IEventServerPattern<CommBasicObjects::CommDigitalInputEventParameter, CommBasicObjects::CommDigitalInputEventResult, CommBasicObjects::CommDigitalInputEventState> * SmartURServerLegacyOpcUaBackendPortFactory::createDigitalInputEventServer(const std::string &serviceName, std::shared_ptr<Smart::IEventTestHandler<CommBasicObjects::CommDigitalInputEventParameter, CommBasicObjects::CommDigitalInputEventResult, CommBasicObjects::CommDigitalInputEventState>> digitalInputEventServerEventTestHandler)
{
	return new SeRoNet::OPCUA::Server::EventServer<CommBasicObjects::CommDigitalInputEventParameter, CommBasicObjects::CommDigitalInputEventResult, CommBasicObjects::CommDigitalInputEventState>(componentImpl, serviceName, digitalInputEventServerEventTestHandler);
}

Smart::IQueryServerPattern<CommBasicObjects::CommIOValues, CommBasicObjects::CommIOValues> * SmartURServerLegacyOpcUaBackendPortFactory::createIoQueryServer(const std::string &serviceName)
{
...
Smart::IEventServerPattern<CommManipulatorObjects::CommManipulatorEventParameter, CommManipulatorObjects::CommManipulatorEventResult, CommManipulatorObjects::CommManipulatorEventState> * SmartURServerLegacyOpcUaBackendPortFactory::createManipulatorEventServiceOut(const std::string &serviceName, std::shared_ptr<Smart::IEventTestHandler<CommManipulatorObjects::CommManipulatorEventParameter, CommManipulatorObjects::CommManipulatorEventResult, CommManipulatorObjects::CommManipulatorEventState>> manipulatorEventServiceOutEventTestHandler)
{
...
Smart::IPushServerPattern<CommManipulatorObjects::CommMobileManipulatorState> * SmartURServerLegacyOpcUaBackendPortFactory::createPosePushServer(const std::string &serviceName)
{
	return new SeRoNet::OPCUA::Server::PushServer<CommManipulatorObjects::CommMobileManipulatorState>(componentImpl, serviceName);
}

Smart::IQueryServerPattern<CommBasicObjects::CommVoid, CommManipulatorObjects::CommMobileManipulatorState> * SmartURServerLegacyOpcUaBackendPortFactory::createPoseQueryServer(const std::string &serviceName)
{
...
Smart::IQueryServerPattern<CommBasicObjects::CommVoid, CommManipulatorObjects::CommMobileManipulatorPrograms> * SmartURServerLegacyOpcUaBackendPortFactory::createProgramQueryServer(const std::string &serviceName)
{
...
Smart::ISendServerPattern<CommManipulatorObjects::CommManipulatorTrajectory> * SmartURServerLegacyOpcUaBackendPortFactory::createTrajectorySendServer(const std::string &serviceName)
{
	return new SeRoNet::OPCUA::Server::SendServer<CommManipulatorObjects::CommManipulatorTrajectory>(componentImpl, serviceName);
}


int SmartURServerLegacyOpcUaBackendPortFactory::task_execution()
{
	componentImpl->run();
	return 0;
}

int SmartURServerLegacyOpcUaBackendPortFactory::onShutdown(const std::chrono::steady_clock::duration &timeoutTime)
{
...
void SmartURServerLegacyOpcUaBackendPortFactory::destroy()
{
