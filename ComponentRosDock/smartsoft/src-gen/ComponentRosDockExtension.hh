...
#ifndef COMPONENTROSDOCK_EXTENSION_HH_
#define COMPONENTROSDOCK_EXTENSION_HH_
...
public:
	ComponentRosDockExtension(const std::string &name);
	virtual ~ComponentRosDockExtension();
...
#endif /* COMPONENTROSDOCK_EXTENSION_HH_ */
