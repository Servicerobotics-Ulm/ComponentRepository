...
#ifndef COMPONENTSYMBOLICPLANNER_EXTENSION_HH_
#define COMPONENTSYMBOLICPLANNER_EXTENSION_HH_
...
public:
	ComponentSymbolicPlannerExtension(const std::string &name);
	virtual ~ComponentSymbolicPlannerExtension();
...
#endif /* COMPONENTSYMBOLICPLANNER_EXTENSION_HH_ */
