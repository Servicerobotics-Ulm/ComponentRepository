...
//
// --------------------------------------------------------------------------
#ifndef _SYMBOLICPANNERQUERYHANDLER_USER_HH
#define _SYMBOLICPANNERQUERYHANDLER_USER_HH
		
#include "SymbolicPannerQueryHandlerCore.hh"

class SymbolicPannerQueryHandler : public SymbolicPannerQueryHandlerCore
{
protected:
public:
