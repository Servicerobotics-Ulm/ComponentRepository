...
#ifndef COMPONENTQTROBOTCONSOLE_EXTENSION_HH_
#define COMPONENTQTROBOTCONSOLE_EXTENSION_HH_
...
public:
	ComponentQtRobotConsoleExtension(const std::string &name);
	virtual ~ComponentQtRobotConsoleExtension();
...
#endif /* COMPONENTQTROBOTCONSOLE_EXTENSION_HH_ */
