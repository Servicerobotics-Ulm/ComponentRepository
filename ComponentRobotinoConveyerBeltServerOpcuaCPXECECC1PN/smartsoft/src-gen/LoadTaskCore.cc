...
Smart::StatusCode LoadTaskCore::loadEventServerPut(CommRobotinoObjects::RobotinoConveyerBeltEventState &eventState)
{
	Smart::StatusCode result = COMP->loadEventServer->put(eventState);
	if(useLogging == true) {
		//FIXME: use logging
