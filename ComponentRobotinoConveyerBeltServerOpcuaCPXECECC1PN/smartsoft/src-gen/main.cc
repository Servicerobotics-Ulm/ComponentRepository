...
int main(int argc, char *argv[])
{
	...
	ComponentRobotinoConveyerBeltServerOpcuaCPXECECC1PN::instance()->init(argc, argv);
	// run component infrastructure until the component is commanded to shutdown
	ComponentRobotinoConveyerBeltServerOpcuaCPXECECC1PN::instance()->run();
	// clean-up component's internal resources (deleting ports, tasks, etc.)
	ComponentRobotinoConveyerBeltServerOpcuaCPXECECC1PN::instance()->fini();
	// destroy the component's singleton
	ComponentRobotinoConveyerBeltServerOpcuaCPXECECC1PN::deleteInstance();
