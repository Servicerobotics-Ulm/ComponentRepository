...
#ifndef COMPONENTROBOTINOCONVEYERBELTSERVEROPCUACPXECECC1PN_EXTENSION_HH_
#define COMPONENTROBOTINOCONVEYERBELTSERVEROPCUACPXECECC1PN_EXTENSION_HH_
...
public:
	ComponentRobotinoConveyerBeltServerOpcuaCPXECECC1PNExtension(const std::string &name);
	virtual ~ComponentRobotinoConveyerBeltServerOpcuaCPXECECC1PNExtension();
...
#endif /* COMPONENTROBOTINOCONVEYERBELTSERVEROPCUACPXECECC1PN_EXTENSION_HH_ */
