...
//--------------------------------------------------------------------------
#ifndef _DEPTHPUSHNEWESTCLIENT_INPUT_COLLECTOR_HH
#define _DEPTHPUSHNEWESTCLIENT_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** DepthPushNewestClientInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort depthPushNewestClient and at the same time acts itself
 ...
 */
class DepthPushNewestClientInputCollector
:	public Smart::IInputHandler<DomainVision::CommDepthImage>
,	public Smart::InputSubject<DomainVision::CommDepthImage>
{
public:
	DepthPushNewestClientInputCollector(Smart::InputSubject<DomainVision::CommDepthImage> *subject)
	:	Smart::IInputHandler<DomainVision::CommDepthImage>(subject)
	{  }
	virtual ~DepthPushNewestClientInputCollector() = default;
...
#endif // _DEPTHPUSHNEWESTCLIENT_INPUT_COLLECTOR_HH
