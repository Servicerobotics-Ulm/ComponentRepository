...
//--------------------------------------------------------------------------
#ifndef _LASERCLIENT1_INPUT_COLLECTOR_HH
#define _LASERCLIENT1_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** LaserClient1InputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort laserClient1 and at the same time acts itself
 ...
 */
class LaserClient1InputCollector
...
{
public:
	LaserClient1InputCollector(Smart::InputSubject<CommBasicObjects::CommMobileLaserScan> *subject)
	:	Smart::IInputHandler<CommBasicObjects::CommMobileLaserScan>(subject)
	{  }
	virtual ~LaserClient1InputCollector() = default;
...
#endif // _LASERCLIENT1_INPUT_COLLECTOR_HH
