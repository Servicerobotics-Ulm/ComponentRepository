...
//--------------------------------------------------------------------------
#ifndef _IMAGEPUSHNEWESTCLIENT_INPUT_COLLECTOR_HH
#define _IMAGEPUSHNEWESTCLIENT_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** ImagePushNewestClientInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort imagePushNewestClient and at the same time acts itself
 ...
 */
class ImagePushNewestClientInputCollector
:	public Smart::IInputHandler<DomainVision::CommVideoImage>
,	public Smart::InputSubject<DomainVision::CommVideoImage>
{
public:
	ImagePushNewestClientInputCollector(Smart::InputSubject<DomainVision::CommVideoImage> *subject)
	:	Smart::IInputHandler<DomainVision::CommVideoImage>(subject)
	{  }
	virtual ~ImagePushNewestClientInputCollector() = default;
...
#endif // _IMAGEPUSHNEWESTCLIENT_INPUT_COLLECTOR_HH
