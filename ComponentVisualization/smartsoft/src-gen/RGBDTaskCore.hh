...
//--------------------------------------------------------------------------
#ifndef _RGBDTASK_CORE_HH
#define _RGBDTASK_CORE_HH
...
#include <RGBDTaskObserverInterface.hh>
...
private:
	...
	std::list<RGBDTaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(RGBDTaskObserverInterface *observer);
	void detach_interaction_observer(RGBDTaskObserverInterface *observer);

public:
	RGBDTaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~RGBDTaskCore();
