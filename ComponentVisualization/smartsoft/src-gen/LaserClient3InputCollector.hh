...
//--------------------------------------------------------------------------
#ifndef _LASERCLIENT3_INPUT_COLLECTOR_HH
#define _LASERCLIENT3_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** LaserClient3InputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort laserClient3 and at the same time acts itself
 ...
 */
class LaserClient3InputCollector
...
{
public:
	LaserClient3InputCollector(Smart::InputSubject<CommBasicObjects::CommMobileLaserScan> *subject)
	:	Smart::IInputHandler<CommBasicObjects::CommMobileLaserScan>(subject)
	{  }
	virtual ~LaserClient3InputCollector() = default;
...
#endif // _LASERCLIENT3_INPUT_COLLECTOR_HH
