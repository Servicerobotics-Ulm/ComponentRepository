...
//--------------------------------------------------------------------------
#ifndef _AMCLVIZTASK_CORE_HH
#define _AMCLVIZTASK_CORE_HH
...
#include <AmclVizTaskObserverInterface.hh>


class AmclVizTaskCore
...
private:
	...
	std::list<AmclVizTaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(AmclVizTaskObserverInterface *observer);
	void detach_interaction_observer(AmclVizTaskObserverInterface *observer);

public:
	AmclVizTaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~AmclVizTaskCore();
