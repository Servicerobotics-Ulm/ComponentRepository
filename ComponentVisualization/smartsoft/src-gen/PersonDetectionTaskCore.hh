...
//--------------------------------------------------------------------------
#ifndef _PERSONDETECTIONTASK_CORE_HH
#define _PERSONDETECTIONTASK_CORE_HH
...
#include <PersonDetectionTaskObserverInterface.hh>


class PersonDetectionTaskCore
...
private:
	...
	std::list<PersonDetectionTaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(PersonDetectionTaskObserverInterface *observer);
	void detach_interaction_observer(PersonDetectionTaskObserverInterface *observer);

public:
	PersonDetectionTaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~PersonDetectionTaskCore();
