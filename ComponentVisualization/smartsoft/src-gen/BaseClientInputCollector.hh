...
//--------------------------------------------------------------------------
#ifndef _BASECLIENT_INPUT_COLLECTOR_HH
#define _BASECLIENT_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** BaseClientInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort baseClient and at the same time acts itself
...
#endif // _BASECLIENT_INPUT_COLLECTOR_HH
