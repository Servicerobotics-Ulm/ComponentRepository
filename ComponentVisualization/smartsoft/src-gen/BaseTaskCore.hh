...
//--------------------------------------------------------------------------
#ifndef _BASETASK_CORE_HH
#define _BASETASK_CORE_HH
...
#include <BaseTaskObserverInterface.hh>
...
private:
	...
	std::list<BaseTaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(BaseTaskObserverInterface *observer);
	void detach_interaction_observer(BaseTaskObserverInterface *observer);

public:
	BaseTaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~BaseTaskCore();
