...
//--------------------------------------------------------------------------
#ifndef _DEPTHTASK_CORE_HH
#define _DEPTHTASK_CORE_HH
...
#include <DepthTaskObserverInterface.hh>
...
private:
	...
	std::list<DepthTaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(DepthTaskObserverInterface *observer);
	void detach_interaction_observer(DepthTaskObserverInterface *observer);

public:
	DepthTaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~DepthTaskCore();
