...
//--------------------------------------------------------------------------
#ifndef _RGBDPUSHNEWESTCLIENT_INPUT_COLLECTOR_HH
#define _RGBDPUSHNEWESTCLIENT_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** RgbdPushNewestClientInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort rgbdPushNewestClient and at the same time acts itself
 ...
 */
class RgbdPushNewestClientInputCollector
:	public Smart::IInputHandler<DomainVision::CommRGBDImage>
,	public Smart::InputSubject<DomainVision::CommRGBDImage>
{
public:
	RgbdPushNewestClientInputCollector(Smart::InputSubject<DomainVision::CommRGBDImage> *subject)
	:	Smart::IInputHandler<DomainVision::CommRGBDImage>(subject)
	{  }
	virtual ~RgbdPushNewestClientInputCollector() = default;
...
#endif // _RGBDPUSHNEWESTCLIENT_INPUT_COLLECTOR_HH
