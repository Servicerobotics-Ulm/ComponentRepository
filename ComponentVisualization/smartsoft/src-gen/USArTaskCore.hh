...
//--------------------------------------------------------------------------
#ifndef _USARTASK_CORE_HH
#define _USARTASK_CORE_HH
...
#include <USArTaskObserverInterface.hh>
...
private:
	...
	std::list<USArTaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(USArTaskObserverInterface *observer);
	void detach_interaction_observer(USArTaskObserverInterface *observer);

public:
	USArTaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~USArTaskCore();
