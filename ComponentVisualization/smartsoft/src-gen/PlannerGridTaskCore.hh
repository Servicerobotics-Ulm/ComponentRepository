...
//--------------------------------------------------------------------------
#ifndef _PLANNERGRIDTASK_CORE_HH
#define _PLANNERGRIDTASK_CORE_HH
...
#include <PlannerGridTaskObserverInterface.hh>


class PlannerGridTaskCore
...
private:
	...
	std::list<PlannerGridTaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(PlannerGridTaskObserverInterface *observer);
	void detach_interaction_observer(PlannerGridTaskObserverInterface *observer);

public:
	PlannerGridTaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~PlannerGridTaskCore();
