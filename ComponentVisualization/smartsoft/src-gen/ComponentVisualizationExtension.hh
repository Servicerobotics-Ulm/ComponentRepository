...
#ifndef COMPONENTVISUALIZATION_EXTENSION_HH_
#define COMPONENTVISUALIZATION_EXTENSION_HH_
...
public:
	ComponentVisualizationExtension(const std::string &name);
	virtual ~ComponentVisualizationExtension();
...
#endif /* COMPONENTVISUALIZATION_EXTENSION_HH_ */
