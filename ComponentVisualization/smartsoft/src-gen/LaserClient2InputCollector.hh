...
//--------------------------------------------------------------------------
#ifndef _LASERCLIENT2_INPUT_COLLECTOR_HH
#define _LASERCLIENT2_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** LaserClient2InputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort laserClient2 and at the same time acts itself
 ...
 */
class LaserClient2InputCollector
...
{
public:
	LaserClient2InputCollector(Smart::InputSubject<CommBasicObjects::CommMobileLaserScan> *subject)
	:	Smart::IInputHandler<CommBasicObjects::CommMobileLaserScan>(subject)
	{  }
	virtual ~LaserClient2InputCollector() = default;
...
#endif // _LASERCLIENT2_INPUT_COLLECTOR_HH
