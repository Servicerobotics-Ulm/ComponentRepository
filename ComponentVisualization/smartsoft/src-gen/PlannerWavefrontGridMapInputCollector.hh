...
//--------------------------------------------------------------------------
#ifndef _PLANNERWAVEFRONTGRIDMAP_INPUT_COLLECTOR_HH
#define _PLANNERWAVEFRONTGRIDMAP_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** PlannerWavefrontGridMapInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort plannerWavefrontGridMap and at the same time acts itself
 ...
 */
class PlannerWavefrontGridMapInputCollector
:	public Smart::IInputHandler<CommNavigationObjects::CommGridMap>
,	public Smart::InputSubject<CommNavigationObjects::CommGridMap>
{
public:
	PlannerWavefrontGridMapInputCollector(Smart::InputSubject<CommNavigationObjects::CommGridMap> *subject)
	:	Smart::IInputHandler<CommNavigationObjects::CommGridMap>(subject)
	{  }
	virtual ~PlannerWavefrontGridMapInputCollector() = default;
...
#endif // _PLANNERWAVEFRONTGRIDMAP_INPUT_COLLECTOR_HH
