...
#ifndef COMPONENTROBOTINOIRSERVER_EXTENSION_HH_
#define COMPONENTROBOTINOIRSERVER_EXTENSION_HH_
...
public:
	ComponentRobotinoIRServerExtension(const std::string &name);
	virtual ~ComponentRobotinoIRServerExtension();
...
#endif /* COMPONENTROBOTINOIRSERVER_EXTENSION_HH_ */
