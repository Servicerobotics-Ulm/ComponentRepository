...
public:
		...
		class CommNavigationObjectsType {
			...
			public:
			/**
			 * Definition of instantiated ParameterSet GMappingParameter
			 */
			class GMappingParameterType {
				friend class ParamUpdateHandler;
				public:
				protected:
					/**
				...
				public:
					...
					void to_ostream(std::ostream &os = std::cout) const
					{
						os << "GMappingParameter(\n";
						os << ")";
					}
			}; // end of parameter-set class GMappingParameterType
			
			protected:
				/**
				 * internal members
				 */
				GMappingParameterType GMappingParameter;
			
			public:
				/**
				 * public getter methods
				 */
				inline GMappingParameterType getGMappingParameter() const { return GMappingParameter; }
				
				void to_ostream(std::ostream &os = std::cout) const
				{
					os << "CommNavigationObjects(\n";
					GMappingParameter.to_ostream(os);
					os << ")";
				}
