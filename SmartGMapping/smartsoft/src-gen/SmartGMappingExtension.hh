...
#ifndef SMARTGMAPPING_EXTENSION_HH_
#define SMARTGMAPPING_EXTENSION_HH_
...
public:
	SmartGMappingExtension(const std::string &name);
	virtual ~SmartGMappingExtension();
...
#endif /* SMARTGMAPPING_EXTENSION_HH_ */
