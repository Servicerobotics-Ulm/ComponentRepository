...
//--------------------------------------------------------------------------
#ifndef _CAMERATASK_CORE_HH
#define _CAMERATASK_CORE_HH
...
#include <CameraTaskObserverInterface.hh>


class CameraTaskCore
...
private:
	...
	std::list<CameraTaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(CameraTaskObserverInterface *observer);
	void detach_interaction_observer(CameraTaskObserverInterface *observer);

public:
	CameraTaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~CameraTaskCore();
