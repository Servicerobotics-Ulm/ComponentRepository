...
//--------------------------------------------------------------------------
#ifndef _VIDEOIMAGECLIENT_INPUT_COLLECTOR_HH
#define _VIDEOIMAGECLIENT_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** VideoImageClientInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort VideoImageClient and at the same time acts itself
 ...
 */
class VideoImageClientInputCollector
:	public Smart::IInputHandler<DomainVision::CommVideoImage>
,	public Smart::InputSubject<DomainVision::CommVideoImage>
{
public:
	VideoImageClientInputCollector(Smart::InputSubject<DomainVision::CommVideoImage> *subject)
	:	Smart::IInputHandler<DomainVision::CommVideoImage>(subject)
	{  }
	virtual ~VideoImageClientInputCollector() = default;
...
#endif // _VIDEOIMAGECLIENT_INPUT_COLLECTOR_HH
