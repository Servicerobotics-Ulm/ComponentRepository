...
#ifndef COMPONENTRGBTOWSSTREAM_EXTENSION_HH_
#define COMPONENTRGBTOWSSTREAM_EXTENSION_HH_
...
public:
	ComponentRGBToWSStreamExtension(const std::string &name);
	virtual ~ComponentRGBToWSStreamExtension();
...
#endif /* COMPONENTRGBTOWSSTREAM_EXTENSION_HH_ */
