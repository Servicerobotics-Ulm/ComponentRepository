...
//
//----------------------------------------------------------------------------
#ifndef _COMPONENTPLAYERSTAGESIMULATORCORE_HH
#define _COMPONENTPLAYERSTAGESIMULATORCORE_HH
...
class ComponentPlayerStageSimulatorCore
{
private:

public:
	ComponentPlayerStageSimulatorCore();
	//ToDo
	SmartACE::SmartMutex RobotPosLock;
	SmartACE::SmartMutex PlayerClientMutex;

	//user stuff:
	PlayerCc::PlayerClient *robot;
	PlayerCc::LaserProxy *laserProxy;
	PlayerCc::Position2dProxy *position_2d_proxy;


	// old globals
	CommBasicObjects::CommBasePose robotPos;
	CommBasicObjects::CommBasePose oldPos;
	CommBasicObjects::CommBasePose rawPos;
