...
Smart::StatusCode ComponentPlayerStageSimulatorImpl::run(void)
{
...
void ComponentPlayerStageSimulatorImpl::closeAllAssociatedTasks(const int &taskShutdownTimeLimit)
{
