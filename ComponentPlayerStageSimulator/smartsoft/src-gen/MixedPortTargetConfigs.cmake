# target configurations for ComponentPlayerStageSimulatorROS1InterfacesExtension

# target configurations for ComponentPlayerStageSimulatorROSExtension
IF(EXISTS ${ROS_DIR})
TARGET_LINK_LIBRARIES(${PROJECT_NAME} ${ROS_LIBS})
ENDIF(EXISTS ${ROS_DIR})

# target configurations for ComponentPlayerStageSimulatorRestInterfacesExtension
