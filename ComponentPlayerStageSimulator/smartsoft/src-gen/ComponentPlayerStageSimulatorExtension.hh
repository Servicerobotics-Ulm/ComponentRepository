...
#ifndef COMPONENTPLAYERSTAGESIMULATOR_EXTENSION_HH_
#define COMPONENTPLAYERSTAGESIMULATOR_EXTENSION_HH_
...
public:
	ComponentPlayerStageSimulatorExtension(const std::string &name);
	virtual ~ComponentPlayerStageSimulatorExtension();
...
#endif /* COMPONENTPLAYERSTAGESIMULATOR_EXTENSION_HH_ */
