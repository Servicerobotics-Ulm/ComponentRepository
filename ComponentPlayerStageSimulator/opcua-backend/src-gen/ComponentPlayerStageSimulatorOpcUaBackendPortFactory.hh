...
#ifndef COMPONENTPLAYERSTAGESIMULATOR_OPC_UA_BACKEND_PORTFACTORY_HH_
#define COMPONENTPLAYERSTAGESIMULATOR_OPC_UA_BACKEND_PORTFACTORY_HH_
...
class ComponentPlayerStageSimulatorOpcUaBackendPortFactory: public ComponentPlayerStageSimulatorPortFactoryInterface
{
private:
	...
	int task_execution();
public:
	ComponentPlayerStageSimulatorOpcUaBackendPortFactory();
	virtual ~ComponentPlayerStageSimulatorOpcUaBackendPortFactory();
...
#endif /* COMPONENTPLAYERSTAGESIMULATOR_SERONET_SDK_PORTFACTORY_HH_ */
