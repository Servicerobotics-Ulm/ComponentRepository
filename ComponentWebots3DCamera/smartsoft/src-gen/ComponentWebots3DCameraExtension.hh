...
#ifndef COMPONENTWEBOTS3DCAMERA_EXTENSION_HH_
#define COMPONENTWEBOTS3DCAMERA_EXTENSION_HH_
...
public:
	ComponentWebots3DCameraExtension(const std::string &name);
	virtual ~ComponentWebots3DCameraExtension();
...
#endif /* COMPONENTWEBOTS3DCAMERA_EXTENSION_HH_ */
