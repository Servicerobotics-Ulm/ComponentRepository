...
#ifndef COMPONENTTRAFFICLIGHT_EXTENSION_HH_
#define COMPONENTTRAFFICLIGHT_EXTENSION_HH_
...
public:
	ComponentTrafficLightExtension(const std::string &name);
	virtual ~ComponentTrafficLightExtension();
...
#endif /* COMPONENTTRAFFICLIGHT_EXTENSION_HH_ */
