...
//--------------------------------------------------------------------------
#ifndef _URPOSEPUSHTIMEDCLIENT_INPUT_COLLECTOR_HH
#define _URPOSEPUSHTIMEDCLIENT_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** UrPosePushTimedClientInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort UrPosePushTimedClient and at the same time acts itself
 ...
 */
class UrPosePushTimedClientInputCollector
...
{
public:
	UrPosePushTimedClientInputCollector(Smart::InputSubject<CommManipulatorObjects::CommMobileManipulatorState> *subject)
	:	Smart::IInputHandler<CommManipulatorObjects::CommMobileManipulatorState>(subject)
	{  }
	virtual ~UrPosePushTimedClientInputCollector() = default;
...
#endif // _URPOSEPUSHTIMEDCLIENT_INPUT_COLLECTOR_HH
