...
#ifndef COMPONENTREALSENSEV2SERVER_EXTENSION_HH_
#define COMPONENTREALSENSEV2SERVER_EXTENSION_HH_
...
public:
	ComponentRealSenseV2ServerExtension(const std::string &name);
	virtual ~ComponentRealSenseV2ServerExtension();
...
#endif /* COMPONENTREALSENSEV2SERVER_EXTENSION_HH_ */
