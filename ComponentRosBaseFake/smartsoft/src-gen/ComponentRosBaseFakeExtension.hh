...
#ifndef COMPONENTROSBASEFAKE_EXTENSION_HH_
#define COMPONENTROSBASEFAKE_EXTENSION_HH_
...
public:
	ComponentRosBaseFakeExtension(const std::string &name);
	virtual ~ComponentRosBaseFakeExtension();
...
#endif /* COMPONENTROSBASEFAKE_EXTENSION_HH_ */
