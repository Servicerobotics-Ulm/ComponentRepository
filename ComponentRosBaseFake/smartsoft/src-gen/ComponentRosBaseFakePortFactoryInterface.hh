...
#ifndef COMPONENTROSBASEFAKE_PORTFACTORYINTERFACE_HH_
#define COMPONENTROSBASEFAKE_PORTFACTORYINTERFACE_HH_
...
// forward declaration
class ComponentRosBaseFake;

class ComponentRosBaseFakePortFactoryInterface {
public:
	ComponentRosBaseFakePortFactoryInterface() { };
	virtual ~ComponentRosBaseFakePortFactoryInterface() { };

	virtual void initialize(ComponentRosBaseFake *component, int argc, char* argv[]) = 0;
...
#endif /* COMPONENTROSBASEFAKE_PORTFACTORYINTERFACE_HH_ */
