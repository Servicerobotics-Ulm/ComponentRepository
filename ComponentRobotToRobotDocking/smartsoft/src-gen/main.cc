...
int main(int argc, char *argv[])
{
	...
	ComponentRobotToRobotDocking::instance()->init(argc, argv);
	// run component infrastructure until the component is commanded to shutdown
	ComponentRobotToRobotDocking::instance()->run();
	// clean-up component's internal resources (deleting ports, tasks, etc.)
	ComponentRobotToRobotDocking::instance()->fini();
	// destroy the component's singleton
	ComponentRobotToRobotDocking::deleteInstance();
