...
//--------------------------------------------------------------------------
#ifndef _BASESTATEPUSHCLIENT_INPUT_COLLECTOR_HH
#define _BASESTATEPUSHCLIENT_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** BaseStatePushClientInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort baseStatePushClient and at the same time acts itself
 ...
 */
class BaseStatePushClientInputCollector
:	public Smart::IInputHandler<CommBasicObjects::CommBaseState>
,	public Smart::InputSubject<CommBasicObjects::CommBaseState>
{
public:
	BaseStatePushClientInputCollector(Smart::InputSubject<CommBasicObjects::CommBaseState> *subject)
	:	Smart::IInputHandler<CommBasicObjects::CommBaseState>(subject)
	{  }
	virtual ~BaseStatePushClientInputCollector() = default;
...
#endif // _BASESTATEPUSHCLIENT_INPUT_COLLECTOR_HH
