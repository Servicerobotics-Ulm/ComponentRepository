...
//--------------------------------------------------------------------------
#ifndef _UNDOCKINGTASK_CORE_HH
#define _UNDOCKINGTASK_CORE_HH
...
#include <UndockingTaskObserverInterface.hh>


class UndockingTaskCore
...
private:
	...
	std::list<UndockingTaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(UndockingTaskObserverInterface *observer);
	void detach_interaction_observer(UndockingTaskObserverInterface *observer);

public:
	UndockingTaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~UndockingTaskCore();
