...
#ifndef COMPONENTROBOTTOROBOTDOCKING_EXTENSION_HH_
#define COMPONENTROBOTTOROBOTDOCKING_EXTENSION_HH_
...
public:
	ComponentRobotToRobotDockingExtension(const std::string &name);
	virtual ~ComponentRobotToRobotDockingExtension();
...
#endif /* COMPONENTROBOTTOROBOTDOCKING_EXTENSION_HH_ */
