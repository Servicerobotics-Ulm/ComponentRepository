...
#ifndef COMPONENTWEBOTSPTUSERVER_OPC_UA_BACKEND_PORTFACTORY_HH_
#define COMPONENTWEBOTSPTUSERVER_OPC_UA_BACKEND_PORTFACTORY_HH_
...
class ComponentWebotsPTUServerOpcUaBackendPortFactory: public ComponentWebotsPTUServerPortFactoryInterface
{
private:
	...
	int task_execution();
public:
	ComponentWebotsPTUServerOpcUaBackendPortFactory();
	virtual ~ComponentWebotsPTUServerOpcUaBackendPortFactory();
...
#endif /* COMPONENTWEBOTSPTUSERVER_SERONET_SDK_PORTFACTORY_HH_ */
