...
#ifndef COMPONENTWEBOTSPTUSERVER_PORTFACTORYINTERFACE_HH_
#define COMPONENTWEBOTSPTUSERVER_PORTFACTORYINTERFACE_HH_
...
// forward declaration
class ComponentWebotsPTUServer;

class ComponentWebotsPTUServerPortFactoryInterface {
public:
	ComponentWebotsPTUServerPortFactoryInterface() { };
	virtual ~ComponentWebotsPTUServerPortFactoryInterface() { };

	virtual void initialize(ComponentWebotsPTUServer *component, int argc, char* argv[]) = 0;
...
#endif /* COMPONENTWEBOTSPTUSERVER_PORTFACTORYINTERFACE_HH_ */
