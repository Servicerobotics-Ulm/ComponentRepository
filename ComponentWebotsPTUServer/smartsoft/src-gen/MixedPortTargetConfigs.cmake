# target configurations for ComponentWebotsPTUServerROS1InterfacesExtension

# target configurations for ComponentWebotsPTUServerROSExtension
IF(EXISTS ${ROS_DIR})
TARGET_LINK_LIBRARIES(${PROJECT_NAME} ${ROS_LIBS})
ENDIF(EXISTS ${ROS_DIR})

# target configurations for ComponentWebotsPTUServerRestInterfacesExtension
...
TARGET_LINK_LIBRARIES(${PROJECT_NAME} DomainPTUOpcUa)
ENDIF(SeRoNetSDK_FOUND)

# target configurations for PlainOpcUaComponentWebotsPTUServerExtension
