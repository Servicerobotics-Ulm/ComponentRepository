...
#ifndef COMPONENTWEBOTSPTUSERVER_EXTENSION_HH_
#define COMPONENTWEBOTSPTUSERVER_EXTENSION_HH_
...
public:
	ComponentWebotsPTUServerExtension(const std::string &name);
	virtual ~ComponentWebotsPTUServerExtension();
...
#endif /* COMPONENTWEBOTSPTUSERVER_EXTENSION_HH_ */
