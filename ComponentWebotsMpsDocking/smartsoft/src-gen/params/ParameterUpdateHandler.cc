...
void ParamUpdateHandler::loadParameter(SmartACE::SmartIniParameter &parameter)
{
	...
	try
	{
		...
		//
		// parameter Webots
		if(parameter.getDouble("Webots", "maxDistanceToDockingPoint", commitState.Webots.maxDistanceToDockingPoint))
		{
			globalState.Webots.maxDistanceToDockingPoint = commitState.Webots.maxDistanceToDockingPoint;
		}
