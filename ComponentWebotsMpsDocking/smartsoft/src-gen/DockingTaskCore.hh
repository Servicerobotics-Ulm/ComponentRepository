...
//--------------------------------------------------------------------------
#ifndef _DOCKINGTASK_CORE_HH
#define _DOCKINGTASK_CORE_HH
...
#include <DockingTaskObserverInterface.hh>


class DockingTaskCore
...
protected:
	...
	// this method is meant to be used in derived classes
	Smart::StatusCode robotDockingEventServiceOutPut(CommRobotinoObjects::RobotinoDockingEventState &eventState);
	// this method is meant to be used in derived classes
...
private:
	...
	std::list<DockingTaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(DockingTaskObserverInterface *observer);
	void detach_interaction_observer(DockingTaskObserverInterface *observer);

public:
	DockingTaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~DockingTaskCore();
