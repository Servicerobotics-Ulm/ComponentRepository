...
#ifndef COMPONENTWEBOTSMPSDOCKING_EXTENSION_HH_
#define COMPONENTWEBOTSMPSDOCKING_EXTENSION_HH_
...
public:
	ComponentWebotsMpsDockingExtension(const std::string &name);
	virtual ~ComponentWebotsMpsDockingExtension();
...
#endif /* COMPONENTWEBOTSMPSDOCKING_EXTENSION_HH_ */
