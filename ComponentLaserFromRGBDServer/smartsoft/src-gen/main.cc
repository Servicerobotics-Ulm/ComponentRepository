...
int main(int argc, char *argv[])
{
	...
	ComponentLaserFromRGBDServer::instance()->init(argc, argv);
	// run component infrastructure until the component is commanded to shutdown
	ComponentLaserFromRGBDServer::instance()->run();
	// clean-up component's internal resources (deleting ports, tasks, etc.)
	ComponentLaserFromRGBDServer::instance()->fini();
	// destroy the component's singleton
	ComponentLaserFromRGBDServer::deleteInstance();
