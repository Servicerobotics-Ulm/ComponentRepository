...
#ifndef COMPONENTLASERFROMRGBDSERVER_EXTENSION_HH_
#define COMPONENTLASERFROMRGBDSERVER_EXTENSION_HH_
...
public:
	ComponentLaserFromRGBDServerExtension(const std::string &name);
	virtual ~ComponentLaserFromRGBDServerExtension();
...
#endif /* COMPONENTLASERFROMRGBDSERVER_EXTENSION_HH_ */
