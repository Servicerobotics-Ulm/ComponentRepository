...
//--------------------------------------------------------------------------
#ifndef _VISTASK_CORE_HH
#define _VISTASK_CORE_HH
...
#include <VisTaskObserverInterface.hh>
...
private:
	...
	std::list<VisTaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(VisTaskObserverInterface *observer);
	void detach_interaction_observer(VisTaskObserverInterface *observer);

public:
	VisTaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~VisTaskCore();
