...
//--------------------------------------------------------------------------
#ifndef _COMPONENTLASERFROMRGBDSERVERCORE_HH
#define _COMPONENTLASERFROMRGBDSERVERCORE_HH
...
class ComponentLaserFromRGBDServerCore
{
private:

public:
	ComponentLaserFromRGBDServerCore();
