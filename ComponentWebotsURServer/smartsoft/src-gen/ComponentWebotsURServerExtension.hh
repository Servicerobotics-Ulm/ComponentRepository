...
#ifndef COMPONENTWEBOTSURSERVER_EXTENSION_HH_
#define COMPONENTWEBOTSURSERVER_EXTENSION_HH_
...
public:
	ComponentWebotsURServerExtension(const std::string &name);
	virtual ~ComponentWebotsURServerExtension();
...
#endif /* COMPONENTWEBOTSURSERVER_EXTENSION_HH_ */
