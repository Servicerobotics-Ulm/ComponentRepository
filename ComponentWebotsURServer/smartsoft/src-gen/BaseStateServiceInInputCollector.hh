...
//--------------------------------------------------------------------------
#ifndef _BASESTATESERVICEIN_INPUT_COLLECTOR_HH
#define _BASESTATESERVICEIN_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** BaseStateServiceInInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort baseStateServiceIn and at the same time acts itself
 ...
 */
class BaseStateServiceInInputCollector
:	public Smart::IInputHandler<CommBasicObjects::CommBaseState>
,	public Smart::InputSubject<CommBasicObjects::CommBaseState>
{
public:
	BaseStateServiceInInputCollector(Smart::InputSubject<CommBasicObjects::CommBaseState> *subject)
	:	Smart::IInputHandler<CommBasicObjects::CommBaseState>(subject)
	{  }
	virtual ~BaseStateServiceInInputCollector() = default;
...
#endif // _BASESTATESERVICEIN_INPUT_COLLECTOR_HH
