...
//--------------------------------------------------------------------------
#ifndef _TRAJECTORYSENDSERVER_INPUT_COLLECTOR_HH
#define _TRAJECTORYSENDSERVER_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** TrajectorySendServerInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort trajectorySendServer and at the same time acts itself
...
#endif // _TRAJECTORYSENDSERVER_INPUT_COLLECTOR_HH
