...
#include "ComponentWebotsURServerOpcUaBackendPortFactory.hh"
...
static ComponentWebotsURServerOpcUaBackendPortFactory OpcUaBackendPortFactory;

ComponentWebotsURServerOpcUaBackendPortFactory::ComponentWebotsURServerOpcUaBackendPortFactory()
{  
	componentImpl = 0;
	ComponentWebotsURServer::instance()->addPortFactory("OpcUa_SeRoNet", this);
}

ComponentWebotsURServerOpcUaBackendPortFactory::~ComponentWebotsURServerOpcUaBackendPortFactory()
{  }

void ComponentWebotsURServerOpcUaBackendPortFactory::initialize(ComponentWebotsURServer *component, int argc, char* argv[])
{
	componentImpl = new SeRoNet::Utils::Component(component->connections.component.name);
}

int ComponentWebotsURServerOpcUaBackendPortFactory::onStartup()
{
	if (!component_thread.joinable()) {
    	component_thread = std::thread(&ComponentWebotsURServerOpcUaBackendPortFactory::task_execution, this);
    	return 0;
    }
	return -1;
}

Smart::IPushClientPattern<CommBasicObjects::CommBaseState> * ComponentWebotsURServerOpcUaBackendPortFactory::createBaseStateServiceIn()
{
	return new SeRoNet::OPCUA::Client::PushClient<CommBasicObjects::CommBaseState>(componentImpl);
}


Smart::IEventServerPattern<CommBasicObjects::CommDigitalInputEventParameter, CommBasicObjects::CommDigitalInputEventResult, CommBasicObjects::CommDigitalInputEventState> * ComponentWebotsURServerOpcUaBackendPortFactory::createIoEventServer(const std::string &serviceName, std::shared_ptr<Smart::IEventTestHandler<CommBasicObjects::CommDigitalInputEventParameter, CommBasicObjects::CommDigitalInputEventResult, CommBasicObjects::CommDigitalInputEventState>> ioEventServerEventTestHandler)
{
...
Smart::IQueryServerPattern<CommBasicObjects::CommIOValues, CommBasicObjects::CommIOValues> * ComponentWebotsURServerOpcUaBackendPortFactory::createIoQueryServer(const std::string &serviceName)
{
...
Smart::IEventServerPattern<CommManipulatorObjects::CommManipulatorEventParameter, CommManipulatorObjects::CommManipulatorEventResult, CommManipulatorObjects::CommManipulatorEventState> * ComponentWebotsURServerOpcUaBackendPortFactory::createManipulatorEventServiceOut(const std::string &serviceName, std::shared_ptr<Smart::IEventTestHandler<CommManipulatorObjects::CommManipulatorEventParameter, CommManipulatorObjects::CommManipulatorEventResult, CommManipulatorObjects::CommManipulatorEventState>> manipulatorEventServiceOutEventTestHandler)
{
...
Smart::IPushServerPattern<CommManipulatorObjects::CommMobileManipulatorState> * ComponentWebotsURServerOpcUaBackendPortFactory::createPosePushServer(const std::string &serviceName)
{
	return new SeRoNet::OPCUA::Server::PushServer<CommManipulatorObjects::CommMobileManipulatorState>(componentImpl, serviceName);
}

Smart::IQueryServerPattern<CommBasicObjects::CommVoid, CommManipulatorObjects::CommMobileManipulatorState> * ComponentWebotsURServerOpcUaBackendPortFactory::createPoseQueryServer(const std::string &serviceName)
{
...
Smart::IQueryServerPattern<CommBasicObjects::CommVoid, CommManipulatorObjects::CommMobileManipulatorPrograms> * ComponentWebotsURServerOpcUaBackendPortFactory::createProgramQuery(const std::string &serviceName)
{
...
Smart::ISendServerPattern<CommManipulatorObjects::CommManipulatorTrajectory> * ComponentWebotsURServerOpcUaBackendPortFactory::createTrajectorySendServer(const std::string &serviceName)
{
	return new SeRoNet::OPCUA::Server::SendServer<CommManipulatorObjects::CommManipulatorTrajectory>(componentImpl, serviceName);
}


int ComponentWebotsURServerOpcUaBackendPortFactory::task_execution()
{
	componentImpl->run();
	return 0;
}

int ComponentWebotsURServerOpcUaBackendPortFactory::onShutdown(const std::chrono::steady_clock::duration &timeoutTime)
{
...
void ComponentWebotsURServerOpcUaBackendPortFactory::destroy()
{
