...
#ifndef COMPONENTWEBOTSURSERVER_OPC_UA_BACKEND_PORTFACTORY_HH_
#define COMPONENTWEBOTSURSERVER_OPC_UA_BACKEND_PORTFACTORY_HH_
...
class ComponentWebotsURServerOpcUaBackendPortFactory: public ComponentWebotsURServerPortFactoryInterface
{
private:
	...
	int task_execution();
public:
	ComponentWebotsURServerOpcUaBackendPortFactory();
	virtual ~ComponentWebotsURServerOpcUaBackendPortFactory();
...
#endif /* COMPONENTWEBOTSURSERVER_SERONET_SDK_PORTFACTORY_HH_ */
