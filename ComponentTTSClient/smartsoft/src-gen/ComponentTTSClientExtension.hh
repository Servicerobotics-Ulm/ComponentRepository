...
#ifndef COMPONENTTTSCLIENT_EXTENSION_HH_
#define COMPONENTTTSCLIENT_EXTENSION_HH_
...
public:
	ComponentTTSClientExtension(const std::string &name);
	virtual ~ComponentTTSClientExtension();
...
#endif /* COMPONENTTTSCLIENT_EXTENSION_HH_ */
