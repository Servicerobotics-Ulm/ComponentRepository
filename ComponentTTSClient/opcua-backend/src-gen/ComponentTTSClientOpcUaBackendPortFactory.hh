...
#ifndef COMPONENTTTSCLIENT_OPC_UA_BACKEND_PORTFACTORY_HH_
#define COMPONENTTTSCLIENT_OPC_UA_BACKEND_PORTFACTORY_HH_
...
class ComponentTTSClientOpcUaBackendPortFactory: public ComponentTTSClientPortFactoryInterface
{
private:
	...
	int task_execution();
public:
	ComponentTTSClientOpcUaBackendPortFactory();
	virtual ~ComponentTTSClientOpcUaBackendPortFactory();
...
#endif /* COMPONENTTTSCLIENT_SERONET_SDK_PORTFACTORY_HH_ */
