...
int main(int argc, char *argv[])
{
	...
	ComponentRobotinoConveyerBeltServer_OPCUA::instance()->init(argc, argv);
	// run component infrastructure until the component is commanded to shutdown
	ComponentRobotinoConveyerBeltServer_OPCUA::instance()->run();
	// clean-up component's internal resources (deleting ports, tasks, etc.)
	ComponentRobotinoConveyerBeltServer_OPCUA::instance()->fini();
	// destroy the component's singleton
	ComponentRobotinoConveyerBeltServer_OPCUA::deleteInstance();
