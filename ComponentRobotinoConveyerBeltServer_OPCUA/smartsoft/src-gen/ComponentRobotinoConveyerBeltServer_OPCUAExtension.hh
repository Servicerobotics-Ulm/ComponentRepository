...
#ifndef COMPONENTROBOTINOCONVEYERBELTSERVER_OPCUA_EXTENSION_HH_
#define COMPONENTROBOTINOCONVEYERBELTSERVER_OPCUA_EXTENSION_HH_
...
public:
	ComponentRobotinoConveyerBeltServer_OPCUAExtension(const std::string &name);
	virtual ~ComponentRobotinoConveyerBeltServer_OPCUAExtension();
...
#endif /* COMPONENTROBOTINOCONVEYERBELTSERVER_OPCUA_EXTENSION_HH_ */
