...
//--------------------------------------------------------------------------
#ifndef _LOADTASK_CORE_HH
#define _LOADTASK_CORE_HH
...
#include <LoadTaskObserverInterface.hh>
...
protected:
	...
	Smart::StatusCode commPowerOutputSendOutPut(CommRobotinoObjects::CommRobotinoPowerOutputValue &commPowerOutputSendOutDataObject);
	// this method is meant to be used in derived classes
...
private:
	...
	std::list<LoadTaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(LoadTaskObserverInterface *observer);
	void detach_interaction_observer(LoadTaskObserverInterface *observer);

public:
	LoadTaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~LoadTaskCore();
