...
#ifndef COMPONENTCARTOGRAPHER_EXTENSION_HH_
#define COMPONENTCARTOGRAPHER_EXTENSION_HH_
...
public:
	ComponentCartographerExtension(const std::string &name);
	virtual ~ComponentCartographerExtension();
...
#endif /* COMPONENTCARTOGRAPHER_EXTENSION_HH_ */
