...
//--------------------------------------------------------------------------
#ifndef _BASETIMEDCLIENT_INPUT_COLLECTOR_HH
#define _BASETIMEDCLIENT_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** BaseTimedClientInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort baseTimedClient and at the same time acts itself
...
#endif // _BASETIMEDCLIENT_INPUT_COLLECTOR_HH
