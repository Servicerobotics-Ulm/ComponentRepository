...
int main(int argc, char *argv[])
{
	...
	ComponentLaserHokuyoURGServer::instance()->init(argc, argv);
	// run component infrastructure until the component is commanded to shutdown
	ComponentLaserHokuyoURGServer::instance()->run();
	// clean-up component's internal resources (deleting ports, tasks, etc.)
	ComponentLaserHokuyoURGServer::instance()->fini();
	// destroy the component's singleton
	ComponentLaserHokuyoURGServer::deleteInstance();
