...
//--------------------------------------------------------------------------
#ifndef _WATCHDOGTASK_CORE_HH
#define _WATCHDOGTASK_CORE_HH
...
#include <WatchDogTaskObserverInterface.hh>


class WatchDogTaskCore
...
private:
	...
	std::list<WatchDogTaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(WatchDogTaskObserverInterface *observer);
	void detach_interaction_observer(WatchDogTaskObserverInterface *observer);

public:
	WatchDogTaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~WatchDogTaskCore();
