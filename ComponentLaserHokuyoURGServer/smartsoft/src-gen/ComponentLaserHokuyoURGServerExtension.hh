...
#ifndef COMPONENTLASERHOKUYOURGSERVER_EXTENSION_HH_
#define COMPONENTLASERHOKUYOURGSERVER_EXTENSION_HH_
...
public:
	ComponentLaserHokuyoURGServerExtension(const std::string &name);
	virtual ~ComponentLaserHokuyoURGServerExtension();
...
#endif /* COMPONENTLASERHOKUYOURGSERVER_EXTENSION_HH_ */
