...
#include "ComponentExerciseDriveMidwayAcePortFactory.hh"


// initialize static singleton pointer to zero
ComponentExerciseDriveMidway* ComponentExerciseDriveMidway::_componentExerciseDriveMidway = 0;

// constructor
ComponentExerciseDriveMidway::ComponentExerciseDriveMidway()
{
	std::cout << "constructor of ComponentExerciseDriveMidway\n";
	...
	connections.component.name = "ComponentExerciseDriveMidway";
...
void ComponentExerciseDriveMidway::addPortFactory(const std::string &name, ComponentExerciseDriveMidwayPortFactoryInterface *portFactory)
{
	portFactoryRegistry[name] = portFactory;
}

void ComponentExerciseDriveMidway::addExtension(ComponentExerciseDriveMidwayExtension *extension)
{
	componentExtensionRegistry[extension->getName()] = extension;
}

SmartACE::SmartComponent* ComponentExerciseDriveMidway::getComponentImpl()
{
	return dynamic_cast<ComponentExerciseDriveMidwayAcePortFactory*>(portFactoryRegistry["ACE_SmartSoft"])->getComponentImpl();
}
 ...
 */
void ComponentExerciseDriveMidway::setStartupFinished() {
	stateSlave->setWaitState("Alive");
	std::cout << "ComponentDefinition initialization/startup finished." << std::endl;
}


Smart::StatusCode ComponentExerciseDriveMidway::connectLaserServiceIn(const std::string &serverName, const std::string &serviceName) {
...
Smart::StatusCode ComponentExerciseDriveMidway::connectNavigationVelocityServiceOut(const std::string &serverName, const std::string &serviceName) {
	Smart::StatusCode status;
 ...
 */
Smart::StatusCode ComponentExerciseDriveMidway::connectAndStartAllServices() {
 ...
 */
void ComponentExerciseDriveMidway::startAllTasks() {
 ...
 */
void ComponentExerciseDriveMidway::startAllTimers() {
}


Smart::TaskTriggerSubject* ComponentExerciseDriveMidway::getInputTaskTriggerFromString(const std::string &client)
{
...
void ComponentExerciseDriveMidway::init(int argc, char *argv[])
{
	try {
		Smart::StatusCode status;
		...
		ComponentExerciseDriveMidwayPortFactoryInterface *acePortFactory = portFactoryRegistry["ACE_SmartSoft"];
		if(acePortFactory == 0) {
		...
		SmartACE::SmartComponent *component = dynamic_cast<ComponentExerciseDriveMidwayAcePortFactory*>(acePortFactory)->getComponentImpl();
		
		std::cout << "ComponentDefinition ComponentExerciseDriveMidway is named " << connections.component.name << std::endl;
...
// run the component
void ComponentExerciseDriveMidway::run()
{
...
void ComponentExerciseDriveMidway::fini()
{
...
void ComponentExerciseDriveMidway::loadParameter(int argc, char *argv[])
{
	/*
	...
	try
	{
		...
		} else if(parameter.searchFile("ComponentExerciseDriveMidway.ini", parameterfile)) {
			parameterFileFound = true;
			std::cout << "load ComponentExerciseDriveMidway.ini parameter file\n";
			parameter.addFile(parameterfile);
		} else {
			std::cout << "WARNING: ComponentExerciseDriveMidway.ini parameter file not found! (using default values or command line arguments)\n";
		}
