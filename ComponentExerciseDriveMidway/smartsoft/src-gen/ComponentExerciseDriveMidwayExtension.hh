...
#ifndef COMPONENTEXERCISEDRIVEMIDWAY_EXTENSION_HH_
#define COMPONENTEXERCISEDRIVEMIDWAY_EXTENSION_HH_
...
public:
	ComponentExerciseDriveMidwayExtension(const std::string &name);
	virtual ~ComponentExerciseDriveMidwayExtension();
...
#endif /* COMPONENTEXERCISEDRIVEMIDWAY_EXTENSION_HH_ */
