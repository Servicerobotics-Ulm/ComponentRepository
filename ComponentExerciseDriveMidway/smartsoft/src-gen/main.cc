...
int main(int argc, char *argv[])
{
	...
	ComponentExerciseDriveMidway::instance()->init(argc, argv);
	// run component infrastructure until the component is commanded to shutdown
	ComponentExerciseDriveMidway::instance()->run();
	// clean-up component's internal resources (deleting ports, tasks, etc.)
	ComponentExerciseDriveMidway::instance()->fini();
	// destroy the component's singleton
	ComponentExerciseDriveMidway::deleteInstance();
