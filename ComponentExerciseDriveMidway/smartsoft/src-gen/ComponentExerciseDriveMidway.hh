...
//--------------------------------------------------------------------------
#ifndef _COMPONENTEXERCISEDRIVEMIDWAY_HH
#define _COMPONENTEXERCISEDRIVEMIDWAY_HH

#include <map>
#include <iostream>
#include "aceSmartSoft.hh"
#include "smartQueryServerTaskTrigger_T.h"
#include "ComponentExerciseDriveMidwayCore.hh"

#include "ComponentExerciseDriveMidwayPortFactoryInterface.hh"
#include "ComponentExerciseDriveMidwayExtension.hh"

// forward declarations
class ComponentExerciseDriveMidwayPortFactoryInterface;
class ComponentExerciseDriveMidwayExtension;

// includes for PlainOpcUaComponentExerciseDriveMidwayExtension
...
#define COMP ComponentExerciseDriveMidway::instance()

class ComponentExerciseDriveMidway : public ComponentExerciseDriveMidwayCore {
private:
	static ComponentExerciseDriveMidway *_componentExerciseDriveMidway;
	
	// constructor
	ComponentExerciseDriveMidway();
	
	// copy-constructor
	ComponentExerciseDriveMidway(const ComponentExerciseDriveMidway& cc);
	...
	std::map<std::string, ComponentExerciseDriveMidwayPortFactoryInterface*> portFactoryRegistry;
	
	// internal map storing various extensions of this component class
	std::map<std::string, ComponentExerciseDriveMidwayExtension*> componentExtensionRegistry;
...
public:
	...
	void addPortFactory(const std::string &name, ComponentExerciseDriveMidwayPortFactoryInterface *portFactory);
	
	SmartACE::SmartComponent* getComponentImpl();
	
	/// this method is used to register different component-extension classes
	void addExtension(ComponentExerciseDriveMidwayExtension *extension);
	...
	static ComponentExerciseDriveMidway* instance()
	{
		if(_componentExerciseDriveMidway == 0) {
			_componentExerciseDriveMidway = new ComponentExerciseDriveMidway();
		}
		return _componentExerciseDriveMidway;
	}
	
	static void deleteInstance() {
		if(_componentExerciseDriveMidway != 0) {
			delete _componentExerciseDriveMidway;
		}
	}
