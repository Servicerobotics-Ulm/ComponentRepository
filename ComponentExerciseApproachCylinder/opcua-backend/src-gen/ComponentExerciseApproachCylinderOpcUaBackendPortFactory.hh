...
#ifndef COMPONENTEXERCISEAPPROACHCYLINDER_OPC_UA_BACKEND_PORTFACTORY_HH_
#define COMPONENTEXERCISEAPPROACHCYLINDER_OPC_UA_BACKEND_PORTFACTORY_HH_
...
class ComponentExerciseApproachCylinderOpcUaBackendPortFactory: public ComponentExerciseApproachCylinderPortFactoryInterface
{
private:
	...
	int task_execution();
public:
	ComponentExerciseApproachCylinderOpcUaBackendPortFactory();
	virtual ~ComponentExerciseApproachCylinderOpcUaBackendPortFactory();
...
#endif /* COMPONENTEXERCISEAPPROACHCYLINDER_SERONET_SDK_PORTFACTORY_HH_ */
