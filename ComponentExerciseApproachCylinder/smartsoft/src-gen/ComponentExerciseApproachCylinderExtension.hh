...
#ifndef COMPONENTEXERCISEAPPROACHCYLINDER_EXTENSION_HH_
#define COMPONENTEXERCISEAPPROACHCYLINDER_EXTENSION_HH_
...
public:
	ComponentExerciseApproachCylinderExtension(const std::string &name);
	virtual ~ComponentExerciseApproachCylinderExtension();
...
#endif /* COMPONENTEXERCISEAPPROACHCYLINDER_EXTENSION_HH_ */
