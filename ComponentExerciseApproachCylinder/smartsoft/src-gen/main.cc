...
int main(int argc, char *argv[])
{
	...
	ComponentExerciseApproachCylinder::instance()->init(argc, argv);
	// run component infrastructure until the component is commanded to shutdown
	ComponentExerciseApproachCylinder::instance()->run();
	// clean-up component's internal resources (deleting ports, tasks, etc.)
	ComponentExerciseApproachCylinder::instance()->fini();
	// destroy the component's singleton
	ComponentExerciseApproachCylinder::deleteInstance();
