...
public:
		...
		public:
			 ...
			 */
			inline bool getUseDebugTask() const { return useDebugTask; }
			inline bool getVerbose() const { return verbose; }
			
			void to_ostream(std::ostream &os = std::cout) const
			{
				os << "Settings(";
				os << "useDebugTask = " << useDebugTask; os << ", ";
				os << "verbose = " << verbose;
				os << ")\n";
			}
		...
		class CommBasicObjectsType {
			...
			public:
			/**
			 * Definition of instantiated ParameterSet Seq2SeqComParam
			 */
			class Seq2SeqComParamType {
				friend class ParamUpdateHandler;
				public:
				protected:
					/**
			...
			}; // end of parameter-set class Seq2SeqComParamType
			
			protected:
				/**
				 * internal members
				 */
				Seq2SeqComParamType Seq2SeqComParam;
			
			public:
				/**
				 * public getter methods
				 */
				inline Seq2SeqComParamType getSeq2SeqComParam() const { return Seq2SeqComParam; }
				
				void to_ostream(std::ostream &os = std::cout) const
				{
					os << "CommBasicObjects(\n";
					Seq2SeqComParam.to_ostream(os);
					os << ")";
				}
...
public:
	...
	std::string getAsJSONString() {
		...
		param["Settings"] = nlohmann::json {
			{"useDebugTask" , getSettings().getUseDebugTask()},
			{"verbose" , getSettings().getVerbose()}
		};
	
		param["Seq2SeqComParam"] = nlohmann::json {
		};
