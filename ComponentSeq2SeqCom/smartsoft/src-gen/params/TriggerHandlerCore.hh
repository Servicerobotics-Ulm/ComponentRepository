...
public:
	...
	// trigger user methods
		...
		virtual void handleCommBasicObjects_Seq2SeqComParam_Send(const std::string &message) = 0;
...
protected:
	...
	public:
		enum ENUM {
			...
			, COMMBASICOBJECTS_SEQ2SEQCOMPARAM_SEND
		};
	};
	...
	// active trigger Send
	struct CommBasicObjects_Seq2SeqComParam_SendAttributes {
		std::string message;
	}current_CommBasicObjects_Seq2SeqComParam_Send;
	std::queue<CommBasicObjects_Seq2SeqComParam_SendAttributes> CommBasicObjects_Seq2SeqComParam_Send_queue;
	
private:
	// trigger internal methods
	void handleCommBasicObjects_Seq2SeqComParam_SendCore(const std::string &message);
