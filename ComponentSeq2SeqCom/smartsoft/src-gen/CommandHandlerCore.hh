...
//--------------------------------------------------------------------------
#ifndef _COMMANDHANDLER_CORE_HH
#define _COMMANDHANDLER_CORE_HH
...
#include <CommandHandlerObserverInterface.hh>
...
private:
	...
	std::list<CommandHandlerObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(CommandHandlerObserverInterface *observer);
	void detach_interaction_observer(CommandHandlerObserverInterface *observer);
