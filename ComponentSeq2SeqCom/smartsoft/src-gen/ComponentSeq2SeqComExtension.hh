...
#ifndef COMPONENTSEQ2SEQCOM_EXTENSION_HH_
#define COMPONENTSEQ2SEQCOM_EXTENSION_HH_
...
public:
	ComponentSeq2SeqComExtension(const std::string &name);
	virtual ~ComponentSeq2SeqComExtension();
...
#endif /* COMPONENTSEQ2SEQCOM_EXTENSION_HH_ */
