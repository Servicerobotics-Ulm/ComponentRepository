...
//--------------------------------------------------------------------------
#ifndef _DEBUGTASK_CORE_HH
#define _DEBUGTASK_CORE_HH
...
#include <DebugTaskObserverInterface.hh>
...
protected:
	...
	Smart::StatusCode taskEventOutPut(CommBasicObjects::CommTaskEventState &eventState);
	// this method is meant to be used in derived classes
	Smart::StatusCode taskSendOutPut(CommBasicObjects::CommTaskMessage &taskSendOutDataObject);
...
private:
	...
	std::list<DebugTaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(DebugTaskObserverInterface *observer);
	void detach_interaction_observer(DebugTaskObserverInterface *observer);

public:
	DebugTaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~DebugTaskCore();
