...
#ifndef COMPONENTTAGRECORDER_EXTENSION_HH_
#define COMPONENTTAGRECORDER_EXTENSION_HH_
...
public:
	ComponentTagRecorderExtension(const std::string &name);
	virtual ~ComponentTagRecorderExtension();
...
#endif /* COMPONENTTAGRECORDER_EXTENSION_HH_ */
