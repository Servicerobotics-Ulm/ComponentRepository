# target configurations for ComponentTagRecorderROS1InterfacesExtension

# target configurations for ComponentTagRecorderROSExtension
IF(EXISTS ${ROS_DIR})
TARGET_LINK_LIBRARIES(${PROJECT_NAME} ${ROS_LIBS})
ENDIF(EXISTS ${ROS_DIR})

# target configurations for ComponentTagRecorderRestInterfacesExtension
...
# target configurations for PlainOpcUaComponentTagRecorderExtension
