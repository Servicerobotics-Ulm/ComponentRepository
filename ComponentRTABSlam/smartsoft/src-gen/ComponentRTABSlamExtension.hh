...
#ifndef COMPONENTRTABSLAM_EXTENSION_HH_
#define COMPONENTRTABSLAM_EXTENSION_HH_
...
public:
	ComponentRTABSlamExtension(const std::string &name);
	virtual ~ComponentRTABSlamExtension();
...
#endif /* COMPONENTRTABSLAM_EXTENSION_HH_ */
