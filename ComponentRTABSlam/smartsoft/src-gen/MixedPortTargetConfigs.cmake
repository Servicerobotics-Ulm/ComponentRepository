# target configurations for ComponentRTABSlamROS1InterfacesExtension

# target configurations for ComponentRTABSlamROSExtension
IF(EXISTS ${ROS_DIR})
TARGET_LINK_LIBRARIES(${PROJECT_NAME} ${ROS_LIBS})
ENDIF(EXISTS ${ROS_DIR})

# target configurations for ComponentRTABSlamRestInterfacesExtension
...
# target configurations for PlainOpcUaComponentRTABSlamExtension
