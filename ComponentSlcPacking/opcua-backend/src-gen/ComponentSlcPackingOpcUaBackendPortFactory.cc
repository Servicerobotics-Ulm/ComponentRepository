...
#include "ComponentSlcPackingOpcUaBackendPortFactory.hh"
...
static ComponentSlcPackingOpcUaBackendPortFactory OpcUaBackendPortFactory;

ComponentSlcPackingOpcUaBackendPortFactory::ComponentSlcPackingOpcUaBackendPortFactory()
{  
	componentImpl = 0;
	ComponentSlcPacking::instance()->addPortFactory("OpcUa_SeRoNet", this);
}

ComponentSlcPackingOpcUaBackendPortFactory::~ComponentSlcPackingOpcUaBackendPortFactory()
{  }

void ComponentSlcPackingOpcUaBackendPortFactory::initialize(ComponentSlcPacking *component, int argc, char* argv[])
{
	componentImpl = new SeRoNet::Utils::Component(component->connections.component.name);
}

int ComponentSlcPackingOpcUaBackendPortFactory::onStartup()
{
	if (!component_thread.joinable()) {
    	component_thread = std::thread(&ComponentSlcPackingOpcUaBackendPortFactory::task_execution, this);
    	return 0;
    }
	return -1;
}

Smart::IQueryClientPattern<CommObjectRecognitionObjects::CommObjectRecognitionId, CommObjectRecognitionObjects::CommObjectRecognitionObjectProperties> * ComponentSlcPackingOpcUaBackendPortFactory::createObjectPropertyQueryClient()
{
...
Smart::IQueryClientPattern<CommBasicObjects::CommVoid, DomainVision::CommRGBDImage> * ComponentSlcPackingOpcUaBackendPortFactory::createRgbdQueryClient()
{
	return new SeRoNet::OPCUA::Client::QueryClient<CommBasicObjects::CommVoid, DomainVision::CommRGBDImage>(componentImpl);
}


Smart::IQueryServerPattern<CommObjectRecognitionObjects::CommObjectRecognitionId, CommObjectRecognitionObjects::CommObjectRecognitionEnvironment> * ComponentSlcPackingOpcUaBackendPortFactory::createEnvironmentQueryServer(const std::string &serviceName)
{
...
Smart::IEventServerPattern<CommBasicObjects::CommVoid, CommObjectRecognitionObjects::CommObjectRecognitionEventResult, CommObjectRecognitionObjects::CommObjectRecognitionEventState> * ComponentSlcPackingOpcUaBackendPortFactory::createObjectEventServer(const std::string &serviceName, std::shared_ptr<Smart::IEventTestHandler<CommBasicObjects::CommVoid, CommObjectRecognitionObjects::CommObjectRecognitionEventResult, CommObjectRecognitionObjects::CommObjectRecognitionEventState>> objectEventServerEventTestHandler)
{
...
Smart::IQueryServerPattern<CommObjectRecognitionObjects::CommObjectRecognitionId, CommObjectRecognitionObjects::CommObjectRecognitionObjectProperties> * ComponentSlcPackingOpcUaBackendPortFactory::createObjectPropertyQueryServer(const std::string &serviceName)
{
...
int ComponentSlcPackingOpcUaBackendPortFactory::task_execution()
{
	componentImpl->run();
	return 0;
}

int ComponentSlcPackingOpcUaBackendPortFactory::onShutdown(const std::chrono::steady_clock::duration &timeoutTime)
{
...
void ComponentSlcPackingOpcUaBackendPortFactory::destroy()
{
