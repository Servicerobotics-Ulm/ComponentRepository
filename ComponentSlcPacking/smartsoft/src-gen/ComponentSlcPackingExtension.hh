...
#ifndef COMPONENTSLCPACKING_EXTENSION_HH_
#define COMPONENTSLCPACKING_EXTENSION_HH_
...
public:
	ComponentSlcPackingExtension(const std::string &name);
	virtual ~ComponentSlcPackingExtension();
...
#endif /* COMPONENTSLCPACKING_EXTENSION_HH_ */
