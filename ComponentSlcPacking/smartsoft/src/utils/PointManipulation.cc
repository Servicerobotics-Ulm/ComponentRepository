...
PointManipulation::PointManipulation(CommBasicObjects::CommPose3d sensor_pose,	std::vector<double> depth_intrinsic, std::vector<double> color_intrinsic, std::vector<double> extrinsic, DomainVision::CommDepthImage* depth_image, DomainVision::CommVideoImage* color_image) {
...
void PointManipulation::setMembers(CommBasicObjects::CommPose3d sensor_pose,	std::vector<double> depth_intrinsic, std::vector<double> color_intrinsic, std::vector<double> extrinsic, DomainVision::CommDepthImage* depth_image, DomainVision::CommVideoImage* color_image) {
	this->sensor_pose = sensor_pose;
	this->depth_intrinsic = depth_intrinsic;
	this->color_intrinsic = color_intrinsic;
	this->_depth_image = depth_image;
...
//	  viewer.showCloud(_point_cloud_in_rgb.makeShared(), "test");
