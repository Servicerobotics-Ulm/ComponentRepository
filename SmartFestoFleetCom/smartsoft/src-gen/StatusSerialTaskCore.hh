...
//--------------------------------------------------------------------------
#ifndef _STATUSSERIALTASK_CORE_HH
#define _STATUSSERIALTASK_CORE_HH
...
#include <StatusSerialTaskObserverInterface.hh>


class StatusSerialTaskCore
...
private:
	...
	std::list<StatusSerialTaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(StatusSerialTaskObserverInterface *observer);
	void detach_interaction_observer(StatusSerialTaskObserverInterface *observer);

public:
	StatusSerialTaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~StatusSerialTaskCore();
