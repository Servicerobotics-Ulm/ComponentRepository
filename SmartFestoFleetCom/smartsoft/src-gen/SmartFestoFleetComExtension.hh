...
#ifndef SMARTFESTOFLEETCOM_EXTENSION_HH_
#define SMARTFESTOFLEETCOM_EXTENSION_HH_
...
public:
	SmartFestoFleetComExtension(const std::string &name);
	virtual ~SmartFestoFleetComExtension();
...
#endif /* SMARTFESTOFLEETCOM_EXTENSION_HH_ */
