...
//--------------------------------------------------------------------------
#ifndef _READCOMMANDTASK_CORE_HH
#define _READCOMMANDTASK_CORE_HH
...
#include <ReadCommandTaskObserverInterface.hh>


class ReadCommandTaskCore
...
private:
	...
	std::list<ReadCommandTaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(ReadCommandTaskObserverInterface *observer);
	void detach_interaction_observer(ReadCommandTaskObserverInterface *observer);

public:
	ReadCommandTaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~ReadCommandTaskCore();
