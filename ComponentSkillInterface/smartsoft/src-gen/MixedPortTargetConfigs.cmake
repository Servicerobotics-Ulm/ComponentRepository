# target configurations for ComponentSkillInterfaceROS1InterfacesExtension

# target configurations for ComponentSkillInterfaceROSExtension
IF(EXISTS ${ROS_DIR})
TARGET_LINK_LIBRARIES(${PROJECT_NAME} ${ROS_LIBS})
ENDIF(EXISTS ${ROS_DIR})

# target configurations for ComponentSkillInterfaceRestInterfacesExtension
...
# target configurations for PlainOpcUaComponentSkillInterfaceExtension
