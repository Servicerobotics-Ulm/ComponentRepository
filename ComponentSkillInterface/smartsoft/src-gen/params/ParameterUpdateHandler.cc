...
void ParamUpdateHandler::loadParameter(SmartACE::SmartIniParameter &parameter)
{
	...
	try
	{
		...
		//
		// parameter Settings
		std::string temp_Settings_communicationType = "";
		if(parameter.getString("Settings", "communicationType", temp_Settings_communicationType))
		{
			commitState.Settings.communicationType = temp_Settings_communicationType;
			globalState.Settings.communicationType = commitState.Settings.communicationType;
		}
		if(parameter.getString("Settings", "ip", commitState.Settings.ip))
		{
			globalState.Settings.ip = commitState.Settings.ip;
		}
		if(parameter.getInteger("Settings", "port", commitState.Settings.port))
		{
