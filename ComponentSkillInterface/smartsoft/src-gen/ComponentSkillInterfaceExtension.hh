...
#ifndef COMPONENTSKILLINTERFACE_EXTENSION_HH_
#define COMPONENTSKILLINTERFACE_EXTENSION_HH_
...
public:
	ComponentSkillInterfaceExtension(const std::string &name);
	virtual ~ComponentSkillInterfaceExtension();
...
#endif /* COMPONENTSKILLINTERFACE_EXTENSION_HH_ */
