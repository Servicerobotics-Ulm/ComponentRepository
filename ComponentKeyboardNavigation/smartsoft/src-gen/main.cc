...
int main(int argc, char *argv[])
{
	...
	ComponentKeyboardNavigation::instance()->init(argc, argv);
	// run component infrastructure until the component is commanded to shutdown
	ComponentKeyboardNavigation::instance()->run();
	// clean-up component's internal resources (deleting ports, tasks, etc.)
	ComponentKeyboardNavigation::instance()->fini();
	// destroy the component's singleton
	ComponentKeyboardNavigation::deleteInstance();
