...
#ifndef COMPONENTKEYBOARDNAVIGATION_EXTENSION_HH_
#define COMPONENTKEYBOARDNAVIGATION_EXTENSION_HH_
...
public:
	ComponentKeyboardNavigationExtension(const std::string &name);
	virtual ~ComponentKeyboardNavigationExtension();
...
#endif /* COMPONENTKEYBOARDNAVIGATION_EXTENSION_HH_ */
