...
//--------------------------------------------------------------------------
#ifndef _KEYBOARDINPUTTASK_CORE_HH
#define _KEYBOARDINPUTTASK_CORE_HH
...
#include <KeyboardInputTaskObserverInterface.hh>


class KeyboardInputTaskCore
...
private:
	...
	std::list<KeyboardInputTaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(KeyboardInputTaskObserverInterface *observer);
	void detach_interaction_observer(KeyboardInputTaskObserverInterface *observer);

public:
	KeyboardInputTaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~KeyboardInputTaskCore();
