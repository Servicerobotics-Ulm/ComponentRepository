...
public:
		...
		public:
			 ...
			 */
			inline double getAngularAcceleration() const { return angularAcceleration; }
			inline double getSpeedAcceleration() const { return speedAcceleration; }
			
			void to_ostream(std::ostream &os = std::cout) const
			{
				os << "Settings(";
				os << "angularAcceleration = " << angularAcceleration; os << ", ";
				os << "speedAcceleration = " << speedAcceleration;
				os << ")\n";
			}
...
public:
	...
	std::string getAsJSONString() {
		...
		param["Settings"] = nlohmann::json {
			{"angularAcceleration" , getSettings().getAngularAcceleration()},
			{"speedAcceleration" , getSettings().getSpeedAcceleration()}
		};
