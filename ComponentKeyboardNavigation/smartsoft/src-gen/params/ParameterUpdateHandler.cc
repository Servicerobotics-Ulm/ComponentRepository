...
void ParamUpdateHandler::loadParameter(SmartACE::SmartIniParameter &parameter)
{
	...
	try
	{
		...
		//
		// parameter Settings
		if(parameter.getDouble("Settings", "angularAcceleration", commitState.Settings.angularAcceleration))
		{
			globalState.Settings.angularAcceleration = commitState.Settings.angularAcceleration;
		}
		if(parameter.getDouble("Settings", "speedAcceleration", commitState.Settings.speedAcceleration))
		{
			globalState.Settings.speedAcceleration = commitState.Settings.speedAcceleration;
		}
