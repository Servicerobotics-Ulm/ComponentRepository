...
#ifndef COMPONENTKINECTV2SERVER_OPC_UA_BACKEND_PORTFACTORY_HH_
#define COMPONENTKINECTV2SERVER_OPC_UA_BACKEND_PORTFACTORY_HH_
...
class ComponentKinectV2ServerOpcUaBackendPortFactory: public ComponentKinectV2ServerPortFactoryInterface
{
private:
	...
	int task_execution();
public:
	ComponentKinectV2ServerOpcUaBackendPortFactory();
	virtual ~ComponentKinectV2ServerOpcUaBackendPortFactory();
...
#endif /* COMPONENTKINECTV2SERVER_SERONET_SDK_PORTFACTORY_HH_ */
