...
//
//--------------------------------------------------------------------------
#ifndef _COMPONENTKINECTV2SERVERCORE_HH
#define _COMPONENTKINECTV2SERVERCORE_HH
...
class ComponentKinectV2ServerCore
{
private:

public:
	ComponentKinectV2ServerCore();
	...
	SmartACE::SmartMutex kinectMutex;
};
