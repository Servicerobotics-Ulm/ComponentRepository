...
//--------------------------------------------------------------------------
#ifndef _PTUPOSEPUSHNEWESTCLIENT_INPUT_COLLECTOR_HH
#define _PTUPOSEPUSHNEWESTCLIENT_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** PtuPosePushNewestClientInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort ptuPosePushNewestClient and at the same time acts itself
 ...
 */
class PtuPosePushNewestClientInputCollector
...
{
public:
	PtuPosePushNewestClientInputCollector(Smart::InputSubject<CommBasicObjects::CommDevicePoseState> *subject)
	:	Smart::IInputHandler<CommBasicObjects::CommDevicePoseState>(subject)
	{  }
	virtual ~PtuPosePushNewestClientInputCollector() = default;
...
#endif // _PTUPOSEPUSHNEWESTCLIENT_INPUT_COLLECTOR_HH
