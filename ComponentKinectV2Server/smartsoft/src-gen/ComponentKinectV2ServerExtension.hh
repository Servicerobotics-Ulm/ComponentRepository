...
#ifndef COMPONENTKINECTV2SERVER_EXTENSION_HH_
#define COMPONENTKINECTV2SERVER_EXTENSION_HH_
...
public:
	ComponentKinectV2ServerExtension(const std::string &name);
	virtual ~ComponentKinectV2ServerExtension();
...
#endif /* COMPONENTKINECTV2SERVER_EXTENSION_HH_ */
