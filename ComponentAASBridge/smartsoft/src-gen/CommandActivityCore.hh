...
//--------------------------------------------------------------------------
#ifndef _COMMANDACTIVITY_CORE_HH
#define _COMMANDACTIVITY_CORE_HH
...
#include <CommandActivityObserverInterface.hh>


class CommandActivityCore
...
private:
	...
	std::list<CommandActivityObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(CommandActivityObserverInterface *observer);
	void detach_interaction_observer(CommandActivityObserverInterface *observer);

public:
	CommandActivityCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~CommandActivityCore();
