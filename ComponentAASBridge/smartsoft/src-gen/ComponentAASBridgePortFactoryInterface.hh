...
#ifndef COMPONENTAASBRIDGE_PORTFACTORYINTERFACE_HH_
#define COMPONENTAASBRIDGE_PORTFACTORYINTERFACE_HH_
...
// forward declaration
class ComponentAASBridge;

class ComponentAASBridgePortFactoryInterface {
public:
	ComponentAASBridgePortFactoryInterface() { };
	virtual ~ComponentAASBridgePortFactoryInterface() { };

	virtual void initialize(ComponentAASBridge *component, int argc, char* argv[]) = 0;
...
#endif /* COMPONENTAASBRIDGE_PORTFACTORYINTERFACE_HH_ */
