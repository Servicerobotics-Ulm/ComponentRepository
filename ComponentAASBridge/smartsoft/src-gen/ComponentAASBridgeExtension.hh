...
#ifndef COMPONENTAASBRIDGE_EXTENSION_HH_
#define COMPONENTAASBRIDGE_EXTENSION_HH_
...
public:
	ComponentAASBridgeExtension(const std::string &name);
	virtual ~ComponentAASBridgeExtension();
...
#endif /* COMPONENTAASBRIDGE_EXTENSION_HH_ */
