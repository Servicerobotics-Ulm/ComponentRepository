...
static ComponentLaserS300ServerAcePortFactory acePortFactory;

ComponentLaserS300ServerAcePortFactory::ComponentLaserS300ServerAcePortFactory()
{  
	componentImpl = 0;
	ComponentLaserS300Server::instance()->addPortFactory("ACE_SmartSoft", this);
}

ComponentLaserS300ServerAcePortFactory::~ComponentLaserS300ServerAcePortFactory()
{  }

void ComponentLaserS300ServerAcePortFactory::initialize(ComponentLaserS300Server *component, int argc, char* argv[])
{
	if(component->connections.component.defaultScheduler != "DEFAULT") {
		...
		componentImpl = new ComponentLaserS300ServerImpl(component->connections.component.name, argc, argv, sched_params);
	} else {
		// create new instance of the SmartSoft component
		componentImpl = new ComponentLaserS300ServerImpl(component->connections.component.name, argc, argv);
	}
}

int ComponentLaserS300ServerAcePortFactory::onStartup()
{
...
SmartACE::SmartComponent* ComponentLaserS300ServerAcePortFactory::getComponentImpl()
{
	return componentImpl;
}

int ComponentLaserS300ServerAcePortFactory::onShutdown(const std::chrono::steady_clock::duration &timeoutTime)
{
	componentImpl->stopComponentInfrastructure(timeoutTime);
	return 0;
}

void ComponentLaserS300ServerAcePortFactory::destroy()
{
