...
#ifndef SMARTPLANNERBREADTHFIRSTSEARCH_EXTENSION_HH_
#define SMARTPLANNERBREADTHFIRSTSEARCH_EXTENSION_HH_
...
public:
	SmartPlannerBreadthFirstSearchExtension(const std::string &name);
	virtual ~SmartPlannerBreadthFirstSearchExtension();
...
#endif /* SMARTPLANNERBREADTHFIRSTSEARCH_EXTENSION_HH_ */
