...
//--------------------------------------------------------------------------
#ifndef _CURMAPCLIENT_INPUT_COLLECTOR_HH
#define _CURMAPCLIENT_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** CurMapClientInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort CurMapClient and at the same time acts itself
...
#endif // _CURMAPCLIENT_INPUT_COLLECTOR_HH
