...
Smart::StatusCode SmartPlannerBreadthFirstSearchImpl::run(void)
{
...
void SmartPlannerBreadthFirstSearchImpl::closeAllAssociatedTasks(const int &taskShutdownTimeLimit)
{
