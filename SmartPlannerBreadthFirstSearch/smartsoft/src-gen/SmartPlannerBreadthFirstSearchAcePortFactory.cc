...
Smart::IPushServerPattern<CommNavigationObjects::CommGridMap> * SmartPlannerBreadthFirstSearchAcePortFactory::createCurrGridMapPushServiceOut(const std::string &serviceName)
{
