...
#ifndef COMPONENTTRAFFICLIGHTTEST_EXTENSION_HH_
#define COMPONENTTRAFFICLIGHTTEST_EXTENSION_HH_
...
public:
	ComponentTrafficLightTestExtension(const std::string &name);
	virtual ~ComponentTrafficLightTestExtension();
...
#endif /* COMPONENTTRAFFICLIGHTTEST_EXTENSION_HH_ */
