...
int main(int argc, char *argv[])
{
	...
	ComponentExerciseFollowWall::instance()->init(argc, argv);
	// run component infrastructure until the component is commanded to shutdown
	ComponentExerciseFollowWall::instance()->run();
	// clean-up component's internal resources (deleting ports, tasks, etc.)
	ComponentExerciseFollowWall::instance()->fini();
	// destroy the component's singleton
	ComponentExerciseFollowWall::deleteInstance();
