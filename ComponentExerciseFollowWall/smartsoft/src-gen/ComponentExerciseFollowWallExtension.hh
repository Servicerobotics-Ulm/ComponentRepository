...
#ifndef COMPONENTEXERCISEFOLLOWWALL_EXTENSION_HH_
#define COMPONENTEXERCISEFOLLOWWALL_EXTENSION_HH_
...
public:
	ComponentExerciseFollowWallExtension(const std::string &name);
	virtual ~ComponentExerciseFollowWallExtension();
...
#endif /* COMPONENTEXERCISEFOLLOWWALL_EXTENSION_HH_ */
