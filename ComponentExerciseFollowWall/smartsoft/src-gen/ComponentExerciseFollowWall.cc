...
ComponentExerciseFollowWall* ComponentExerciseFollowWall::_componentExerciseFollowWall = 0;

// constructor
ComponentExerciseFollowWall::ComponentExerciseFollowWall()
{
	std::cout << "constructor of ComponentExerciseFollowWall\n";
	...
	connections.component.name = "ComponentExerciseFollowWall";
...
void ComponentExerciseFollowWall::addPortFactory(const std::string &name, ComponentExerciseFollowWallPortFactoryInterface *portFactory)
{
	portFactoryRegistry[name] = portFactory;
}

void ComponentExerciseFollowWall::addExtension(ComponentExerciseFollowWallExtension *extension)
{
	componentExtensionRegistry[extension->getName()] = extension;
}

SmartACE::SmartComponent* ComponentExerciseFollowWall::getComponentImpl()
{
	return dynamic_cast<ComponentExerciseFollowWallAcePortFactory*>(portFactoryRegistry["ACE_SmartSoft"])->getComponentImpl();
}
 ...
 */
void ComponentExerciseFollowWall::setStartupFinished() {
	stateSlave->setWaitState("Alive");
	std::cout << "ComponentDefinition initialization/startup finished." << std::endl;
}


Smart::StatusCode ComponentExerciseFollowWall::connectLaserServiceIn(const std::string &serverName, const std::string &serviceName) {
...
Smart::StatusCode ComponentExerciseFollowWall::connectNavigationVelocityServiceOut(const std::string &serverName, const std::string &serviceName) {
	Smart::StatusCode status;
 ...
 */
Smart::StatusCode ComponentExerciseFollowWall::connectAndStartAllServices() {
 ...
 */
void ComponentExerciseFollowWall::startAllTasks() {
 ...
 */
void ComponentExerciseFollowWall::startAllTimers() {
}


Smart::TaskTriggerSubject* ComponentExerciseFollowWall::getInputTaskTriggerFromString(const std::string &client)
{
...
void ComponentExerciseFollowWall::init(int argc, char *argv[])
{
	try {
		Smart::StatusCode status;
		...
		ComponentExerciseFollowWallPortFactoryInterface *acePortFactory = portFactoryRegistry["ACE_SmartSoft"];
		if(acePortFactory == 0) {
		...
		SmartACE::SmartComponent *component = dynamic_cast<ComponentExerciseFollowWallAcePortFactory*>(acePortFactory)->getComponentImpl();
		
		std::cout << "ComponentDefinition ComponentExerciseFollowWall is named " << connections.component.name << std::endl;
...
// run the component
void ComponentExerciseFollowWall::run()
{
...
void ComponentExerciseFollowWall::fini()
{
...
void ComponentExerciseFollowWall::loadParameter(int argc, char *argv[])
{
	/*
	...
	try
	{
		...
		} else if(parameter.searchFile("ComponentExerciseFollowWall.ini", parameterfile)) {
			parameterFileFound = true;
			std::cout << "load ComponentExerciseFollowWall.ini parameter file\n";
			parameter.addFile(parameterfile);
		} else {
			std::cout << "WARNING: ComponentExerciseFollowWall.ini parameter file not found! (using default values or command line arguments)\n";
		}
