...
//--------------------------------------------------------------------------
#ifndef _RGBDIMAGEPUSHSERVICEIN_INPUT_COLLECTOR_HH
#define _RGBDIMAGEPUSHSERVICEIN_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** RGBDImagePushServiceInInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort RGBDImagePushServiceIn and at the same time acts itself
 ...
 */
class RGBDImagePushServiceInInputCollector
:	public Smart::IInputHandler<DomainVision::CommRGBDImage>
,	public Smart::InputSubject<DomainVision::CommRGBDImage>
{
public:
	RGBDImagePushServiceInInputCollector(Smart::InputSubject<DomainVision::CommRGBDImage> *subject)
	:	Smart::IInputHandler<DomainVision::CommRGBDImage>(subject)
	{  }
	virtual ~RGBDImagePushServiceInInputCollector() = default;
...
#endif // _RGBDIMAGEPUSHSERVICEIN_INPUT_COLLECTOR_HH
