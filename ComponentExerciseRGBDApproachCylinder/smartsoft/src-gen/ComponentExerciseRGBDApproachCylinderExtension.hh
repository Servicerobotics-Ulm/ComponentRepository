...
#ifndef COMPONENTEXERCISERGBDAPPROACHCYLINDER_EXTENSION_HH_
#define COMPONENTEXERCISERGBDAPPROACHCYLINDER_EXTENSION_HH_
...
public:
	ComponentExerciseRGBDApproachCylinderExtension(const std::string &name);
	virtual ~ComponentExerciseRGBDApproachCylinderExtension();
...
#endif /* COMPONENTEXERCISERGBDAPPROACHCYLINDER_EXTENSION_HH_ */
