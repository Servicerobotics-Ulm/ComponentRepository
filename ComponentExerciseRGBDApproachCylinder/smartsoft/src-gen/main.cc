...
int main(int argc, char *argv[])
{
	...
	ComponentExerciseRGBDApproachCylinder::instance()->init(argc, argv);
	// run component infrastructure until the component is commanded to shutdown
	ComponentExerciseRGBDApproachCylinder::instance()->run();
	// clean-up component's internal resources (deleting ports, tasks, etc.)
	ComponentExerciseRGBDApproachCylinder::instance()->fini();
	// destroy the component's singleton
	ComponentExerciseRGBDApproachCylinder::deleteInstance();
