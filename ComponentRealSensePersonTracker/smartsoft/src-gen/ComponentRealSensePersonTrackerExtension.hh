...
#ifndef COMPONENTREALSENSEPERSONTRACKER_EXTENSION_HH_
#define COMPONENTREALSENSEPERSONTRACKER_EXTENSION_HH_
...
public:
	ComponentRealSensePersonTrackerExtension(const std::string &name);
	virtual ~ComponentRealSensePersonTrackerExtension();
...
#endif /* COMPONENTREALSENSEPERSONTRACKER_EXTENSION_HH_ */
