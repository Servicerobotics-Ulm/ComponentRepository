...
//--------------------------------------------------------------------------
#ifndef _REALSENSECLIENT_INPUT_COLLECTOR_HH
#define _REALSENSECLIENT_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** RealSenseClientInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort RealSenseClient and at the same time acts itself
 ...
 */
class RealSenseClientInputCollector
:	public Smart::IInputHandler<DomainVision::CommRGBDImage>
,	public Smart::InputSubject<DomainVision::CommRGBDImage>
{
public:
	RealSenseClientInputCollector(Smart::InputSubject<DomainVision::CommRGBDImage> *subject)
	:	Smart::IInputHandler<DomainVision::CommRGBDImage>(subject)
	{  }
	virtual ~RealSenseClientInputCollector() = default;
...
#endif // _REALSENSECLIENT_INPUT_COLLECTOR_HH
