...
int main(int argc, char *argv[])
{
	...
	ComponentRealSensePersonTracker::instance()->init(argc, argv);
	// run component infrastructure until the component is commanded to shutdown
	ComponentRealSensePersonTracker::instance()->run();
	// clean-up component's internal resources (deleting ports, tasks, etc.)
	ComponentRealSensePersonTracker::instance()->fini();
	// destroy the component's singleton
	ComponentRealSensePersonTracker::deleteInstance();
