...
//--------------------------------------------------------------------------
#ifndef _LASERCLIENT_INPUT_COLLECTOR_HH
#define _LASERCLIENT_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** LaserClientInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort LaserClient and at the same time acts itself
 ...
 */
class LaserClientInputCollector
...
{
public:
	LaserClientInputCollector(Smart::InputSubject<CommBasicObjects::CommMobileLaserScan> *subject)
	:	Smart::IInputHandler<CommBasicObjects::CommMobileLaserScan>(subject)
	{  }
	virtual ~LaserClientInputCollector() = default;
...
#endif // _LASERCLIENT_INPUT_COLLECTOR_HH
