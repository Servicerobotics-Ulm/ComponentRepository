...
#ifndef SMARTCDLSERVER_EXTENSION_HH_
#define SMARTCDLSERVER_EXTENSION_HH_
...
public:
	SmartCdlServerExtension(const std::string &name);
	virtual ~SmartCdlServerExtension();
...
#endif /* SMARTCDLSERVER_EXTENSION_HH_ */
