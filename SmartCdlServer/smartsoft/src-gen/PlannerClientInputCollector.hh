...
//--------------------------------------------------------------------------
#ifndef _PLANNERCLIENT_INPUT_COLLECTOR_HH
#define _PLANNERCLIENT_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** PlannerClientInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort PlannerClient and at the same time acts itself
 ...
 */
class PlannerClientInputCollector
...
{
public:
	PlannerClientInputCollector(Smart::InputSubject<CommNavigationObjects::CommPlannerGoal> *subject)
	:	Smart::IInputHandler<CommNavigationObjects::CommPlannerGoal>(subject)
	{  }
	virtual ~PlannerClientInputCollector() = default;
...
#endif // _PLANNERCLIENT_INPUT_COLLECTOR_HH
