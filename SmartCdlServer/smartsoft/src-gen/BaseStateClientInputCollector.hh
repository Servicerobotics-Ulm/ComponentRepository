...
//--------------------------------------------------------------------------
#ifndef _BASESTATECLIENT_INPUT_COLLECTOR_HH
#define _BASESTATECLIENT_INPUT_COLLECTOR_HH

#include "aceSmartSoft.hh"

/** BaseStateClientInputCollector colelcts inputs from multiple input-port instances and acts as a single source
 *
 * This class implements an InputHandler for the InputPort BaseStateClient and at the same time acts itself
...
#endif // _BASESTATECLIENT_INPUT_COLLECTOR_HH
