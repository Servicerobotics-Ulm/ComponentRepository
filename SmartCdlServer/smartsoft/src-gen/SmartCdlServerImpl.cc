...
SmartCdlServerImpl::SmartCdlServerImpl(const std::string &componentName, int & argc, char ** argv)
:	SmartACE::SmartComponent(componentName, argc, argv)
{  }

SmartCdlServerImpl::SmartCdlServerImpl(const std::string &componentName, int & argc, char ** argv, const ACE_Sched_Params &sched_params)
:	SmartACE::SmartComponent(componentName, argc, argv, NULL, sched_params)
{  }

SmartCdlServerImpl::~SmartCdlServerImpl() 
{  }

int SmartCdlServerImpl::startComponentInfrastructure(void)
{
...
void SmartCdlServerImpl::stopComponentInfrastructure(const std::chrono::steady_clock::duration &timeoutTime)
{
	this->signalSmartTasksToStop(timeoutTime);
}
void SmartCdlServerImpl::cleanUpComponentResources()
{
